var lc=Object.defineProperty;var oh=(i,t,e)=>t in i?lc(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var mn=(i,t,e)=>()=>{if(e)throw e[0];try{return i&&(t=i(i=0)),t}catch(n){throw e=[n],n}};var ch=(i,t)=>()=>{try{return t||i((t={exports:{}}).exports,t),t.exports}catch(e){throw t=0,e}},lh=(i,t)=>{for(var e in t)lc(i,e,{get:t[e],enumerable:!0})};var ee=(i,t,e)=>oh(i,typeof t!="symbol"?t+"":t,e);function Xi(){let i=Math.random()*4294967295|0,t=Math.random()*4294967295|0,e=Math.random()*4294967295|0,n=Math.random()*4294967295|0;return(pe[i&255]+pe[i>>8&255]+pe[i>>16&255]+pe[i>>24&255]+"-"+pe[t&255]+pe[t>>8&255]+"-"+pe[t>>16&15|64]+pe[t>>24&255]+"-"+pe[e&63|128]+pe[e>>8&255]+"-"+pe[e>>16&255]+pe[e>>24&255]+pe[n&255]+pe[n>>8&255]+pe[n>>16&255]+pe[n>>24&255]).toLowerCase()}function we(i,t,e){return Math.max(t,Math.min(e,i))}function Kh(i,t){return(i%t+t)%t}function Pr(i,t,e){return(1-e)*i+e*t}function Pi(i,t){switch(t.constructor){case Float32Array:return i;case Uint32Array:return i/4294967295;case Uint16Array:return i/65535;case Uint8Array:return i/255;case Int32Array:return Math.max(i/2147483647,-1);case Int16Array:return Math.max(i/32767,-1);case Int8Array:return Math.max(i/127,-1);default:throw new Error("Invalid component type.")}}function be(i,t){switch(t.constructor){case Float32Array:return i;case Uint32Array:return Math.round(i*4294967295);case Uint16Array:return Math.round(i*65535);case Uint8Array:return Math.round(i*255);case Int32Array:return Math.round(i*2147483647);case Int16Array:return Math.round(i*32767);case Int8Array:return Math.round(i*127);default:throw new Error("Invalid component type.")}}function El(i){for(let t=i.length-1;t>=0;--t)if(i[t]>=65535)return!0;return!1}function Bs(i){return document.createElementNS("http://www.w3.org/1999/xhtml",i)}function Jh(){let i=Bs("canvas");return i.style.display="block",i}function Is(i){i in vc||(vc[i]=!0,console.warn(i))}function Qh(i,t,e){return new Promise(function(n,s){function r(){switch(i.clientWaitSync(t,i.SYNC_FLUSH_COMMANDS_BIT,0)){case i.WAIT_FAILED:s();break;case i.TIMEOUT_EXPIRED:setTimeout(r,e);break;default:n()}}setTimeout(r,e)})}function tu(i){let t=i.elements;t[2]=.5*t[2]+.5*t[3],t[6]=.5*t[6]+.5*t[7],t[10]=.5*t[10]+.5*t[11],t[14]=.5*t[14]+.5*t[15]}function eu(i){let t=i.elements;t[11]===-1?(t[10]=-t[10]-1,t[14]=-t[14]):(t[10]=-t[10],t[14]=-t[14]+1)}function yi(i){return i<.04045?i*.0773993808:Math.pow(i*.9478672986+.0521327014,2.4)}function Ur(i){return i<.0031308?i*12.92:1.055*Math.pow(i,.41666)-.055}function Dr(i){return typeof HTMLImageElement<"u"&&i instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&i instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&i instanceof ImageBitmap?Xa.getDataURL(i):i.data?{data:Array.from(i.data),width:i.width,height:i.height,type:i.data.constructor.name}:(console.warn("THREE.Texture: Unable to serialize Texture."),{})}function Br(i,t,e,n,s){for(let r=0,a=i.length-3;r<=a;r+=3){On.fromArray(i,r);let o=s.x*Math.abs(On.x)+s.y*Math.abs(On.y)+s.z*Math.abs(On.z),c=t.dot(On),l=e.dot(On),h=n.dot(On);if(Math.max(-Math.max(c,l,h),Math.min(c,l,h))>o)return!1}return!0}function $r(i,t,e){return e<0&&(e+=1),e>1&&(e-=1),e<1/6?i+(t-i)*6*e:e<1/2?t:e<2/3?i+(t-i)*6*(2/3-e):i}function pu(i,t,e,n,s,r,a,o){let c;if(t.side===Re?c=n.intersectTriangle(a,r,s,!0,o):c=n.intersectTriangle(s,r,a,t.side===wn,o),c===null)return null;As.copy(o),As.applyMatrix4(i.matrixWorld);let l=e.ray.origin.distanceTo(As);return l<e.near||l>e.far?null:{distance:l,point:As.clone(),object:i}}function _s(i,t,e,n,s,r,a,o,c,l){i.getVertexPosition(o,fs),i.getVertexPosition(c,ps),i.getVertexPosition(l,ms);let h=pu(i,t,e,n,fs,ps,ms,Dc);if(h){let p=new L;Wn.getBarycoord(Dc,fs,ps,ms,p),s&&(h.uv=Wn.getInterpolatedAttribute(s,o,c,l,p,new jt)),r&&(h.uv1=Wn.getInterpolatedAttribute(r,o,c,l,p,new jt)),a&&(h.normal=Wn.getInterpolatedAttribute(a,o,c,l,p,new L),h.normal.dot(n.direction)>0&&h.normal.multiplyScalar(-1));let f={a:o,b:c,c:l,normal:new L,materialIndex:0};Wn.getNormal(fs,ps,ms,f.normal),h.face=f,h.barycoord=p}return h}function Ri(i){let t={};for(let e in i){t[e]={};for(let n in i[e]){let s=i[e][n];s&&(s.isColor||s.isMatrix3||s.isMatrix4||s.isVector2||s.isVector3||s.isVector4||s.isTexture||s.isQuaternion)?s.isRenderTargetTexture?(console.warn("UniformsUtils: Textures of render targets cannot be cloned via cloneUniforms() or mergeUniforms()."),t[e][n]=null):t[e][n]=s.clone():Array.isArray(s)?t[e][n]=s.slice():t[e][n]=s}}return t}function xe(i){let t={};for(let e=0;e<i.length;e++){let n=Ri(i[e]);for(let s in n)t[s]=n[s]}return t}function mu(i){let t=[];for(let e=0;e<i.length;e++)t.push(i[e].clone());return t}function Tl(i){let t=i.getRenderTarget();return t===null?i.outputColorSpace:t.isXRRenderTarget===!0?t.texture.colorSpace:Wt.workingColorSpace}function Rl(){let i=null,t=!1,e=null,n=null;function s(r,a){e(r,a),n=i.requestAnimationFrame(s)}return{start:function(){t!==!0&&e!==null&&(n=i.requestAnimationFrame(s),t=!0)},stop:function(){i.cancelAnimationFrame(n),t=!1},setAnimationLoop:function(r){e=r},setContext:function(r){i=r}}}function yu(i){let t=new WeakMap;function e(o,c){let l=o.array,h=o.usage,p=l.byteLength,f=i.createBuffer();i.bindBuffer(c,f),i.bufferData(c,l,h),o.onUploadCallback();let m;if(l instanceof Float32Array)m=i.FLOAT;else if(l instanceof Uint16Array)o.isFloat16BufferAttribute?m=i.HALF_FLOAT:m=i.UNSIGNED_SHORT;else if(l instanceof Int16Array)m=i.SHORT;else if(l instanceof Uint32Array)m=i.UNSIGNED_INT;else if(l instanceof Int32Array)m=i.INT;else if(l instanceof Int8Array)m=i.BYTE;else if(l instanceof Uint8Array)m=i.UNSIGNED_BYTE;else if(l instanceof Uint8ClampedArray)m=i.UNSIGNED_BYTE;else throw new Error("THREE.WebGLAttributes: Unsupported buffer data format: "+l);return{buffer:f,type:m,bytesPerElement:l.BYTES_PER_ELEMENT,version:o.version,size:p}}function n(o,c,l){let h=c.array,p=c.updateRanges;if(i.bindBuffer(l,o),p.length===0)i.bufferSubData(l,0,h);else{p.sort((m,_)=>m.start-_.start);let f=0;for(let m=1;m<p.length;m++){let _=p[f],y=p[m];y.start<=_.start+_.count+1?_.count=Math.max(_.count,y.start+y.count-_.start):(++f,p[f]=y)}p.length=f+1;for(let m=0,_=p.length;m<_;m++){let y=p[m];i.bufferSubData(l,y.start*h.BYTES_PER_ELEMENT,h,y.start,y.count)}c.clearUpdateRanges()}c.onUploadCallback()}function s(o){return o.isInterleavedBufferAttribute&&(o=o.data),t.get(o)}function r(o){o.isInterleavedBufferAttribute&&(o=o.data);let c=t.get(o);c&&(i.deleteBuffer(c.buffer),t.delete(o))}function a(o,c){if(o.isInterleavedBufferAttribute&&(o=o.data),o.isGLBufferAttribute){let h=t.get(o);(!h||h.version<o.version)&&t.set(o,{buffer:o.buffer,type:o.type,bytesPerElement:o.elementSize,version:o.version});return}let l=t.get(o);if(l===void 0)t.set(o,e(o,c));else if(l.version<o.version){if(l.size!==o.array.byteLength)throw new Error("THREE.WebGLAttributes: The size of the buffer attribute's array buffer does not match the original size. Resizing buffer attributes is not supported.");n(l.buffer,o,c),l.version=o.version}}return{get:s,remove:r,update:a}}function ip(i,t,e,n,s,r,a){let o=new Pt(0),c=r===!0?0:1,l,h,p=null,f=0,m=null;function _(b){let M=b.isScene===!0?b.background:null;return M&&M.isTexture&&(M=(b.backgroundBlurriness>0?e:t).get(M)),M}function y(b){let M=!1,E=_(b);E===null?u(o,c):E&&E.isColor&&(u(E,1),M=!0);let B=i.xr.getEnvironmentBlendMode();B==="additive"?n.buffers.color.setClear(0,0,0,1,a):B==="alpha-blend"&&n.buffers.color.setClear(0,0,0,0,a),(i.autoClear||M)&&(n.buffers.depth.setTest(!0),n.buffers.depth.setMask(!0),n.buffers.color.setMask(!0),i.clear(i.autoClearColor,i.autoClearDepth,i.autoClearStencil))}function d(b,M){let E=_(M);E&&(E.isCubeTexture||E.mapping===er)?(h===void 0&&(h=new fe(new In(1,1,1),new Ze({name:"BackgroundCubeMaterial",uniforms:Ri(Xe.backgroundCube.uniforms),vertexShader:Xe.backgroundCube.vertexShader,fragmentShader:Xe.backgroundCube.fragmentShader,side:Re,depthTest:!1,depthWrite:!1,fog:!1})),h.geometry.deleteAttribute("normal"),h.geometry.deleteAttribute("uv"),h.onBeforeRender=function(B,C,w){this.matrixWorld.copyPosition(w.matrixWorld)},Object.defineProperty(h.material,"envMap",{get:function(){return this.uniforms.envMap.value}}),s.update(h)),jn.copy(M.backgroundRotation),jn.x*=-1,jn.y*=-1,jn.z*=-1,E.isCubeTexture&&E.isRenderTargetTexture===!1&&(jn.y*=-1,jn.z*=-1),h.material.uniforms.envMap.value=E,h.material.uniforms.flipEnvMap.value=E.isCubeTexture&&E.isRenderTargetTexture===!1?-1:1,h.material.uniforms.backgroundBlurriness.value=M.backgroundBlurriness,h.material.uniforms.backgroundIntensity.value=M.backgroundIntensity,h.material.uniforms.backgroundRotation.value.setFromMatrix4(np.makeRotationFromEuler(jn)),h.material.toneMapped=Wt.getTransfer(E.colorSpace)!==Qt,(p!==E||f!==E.version||m!==i.toneMapping)&&(h.material.needsUpdate=!0,p=E,f=E.version,m=i.toneMapping),h.layers.enableAll(),b.unshift(h,h.geometry,h.material,0,0,null)):E&&E.isTexture&&(l===void 0&&(l=new fe(new Pn(2,2),new Ze({name:"BackgroundMaterial",uniforms:Ri(Xe.background.uniforms),vertexShader:Xe.background.vertexShader,fragmentShader:Xe.background.fragmentShader,side:wn,depthTest:!1,depthWrite:!1,fog:!1})),l.geometry.deleteAttribute("normal"),Object.defineProperty(l.material,"map",{get:function(){return this.uniforms.t2D.value}}),s.update(l)),l.material.uniforms.t2D.value=E,l.material.uniforms.backgroundIntensity.value=M.backgroundIntensity,l.material.toneMapped=Wt.getTransfer(E.colorSpace)!==Qt,E.matrixAutoUpdate===!0&&E.updateMatrix(),l.material.uniforms.uvTransform.value.copy(E.matrix),(p!==E||f!==E.version||m!==i.toneMapping)&&(l.material.needsUpdate=!0,p=E,f=E.version,m=i.toneMapping),l.layers.enableAll(),b.unshift(l,l.geometry,l.material,0,0,null))}function u(b,M){b.getRGB(vs,Tl(i)),n.buffers.color.setClear(vs.r,vs.g,vs.b,M,a)}return{getClearColor:function(){return o},setClearColor:function(b,M=1){o.set(b),c=M,u(o,c)},getClearAlpha:function(){return c},setClearAlpha:function(b){c=b,u(o,c)},render:y,addToRenderList:d}}function sp(i,t){let e=i.getParameter(i.MAX_VERTEX_ATTRIBS),n={},s=f(null),r=s,a=!1;function o(g,v,k,F,V){let Y=!1,z=p(F,k,v);r!==z&&(r=z,l(r.object)),Y=m(g,F,k,V),Y&&_(g,F,k,V),V!==null&&t.update(V,i.ELEMENT_ARRAY_BUFFER),(Y||a)&&(a=!1,E(g,v,k,F),V!==null&&i.bindBuffer(i.ELEMENT_ARRAY_BUFFER,t.get(V).buffer))}function c(){return i.createVertexArray()}function l(g){return i.bindVertexArray(g)}function h(g){return i.deleteVertexArray(g)}function p(g,v,k){let F=k.wireframe===!0,V=n[g.id];V===void 0&&(V={},n[g.id]=V);let Y=V[v.id];Y===void 0&&(Y={},V[v.id]=Y);let z=Y[F];return z===void 0&&(z=f(c()),Y[F]=z),z}function f(g){let v=[],k=[],F=[];for(let V=0;V<e;V++)v[V]=0,k[V]=0,F[V]=0;return{geometry:null,program:null,wireframe:!1,newAttributes:v,enabledAttributes:k,attributeDivisors:F,object:g,attributes:{},index:null}}function m(g,v,k,F){let V=r.attributes,Y=v.attributes,z=0,K=k.getAttributes();for(let H in K)if(K[H].location>=0){let ct=V[H],gt=Y[H];if(gt===void 0&&(H==="instanceMatrix"&&g.instanceMatrix&&(gt=g.instanceMatrix),H==="instanceColor"&&g.instanceColor&&(gt=g.instanceColor)),ct===void 0||ct.attribute!==gt||gt&&ct.data!==gt.data)return!0;z++}return r.attributesNum!==z||r.index!==F}function _(g,v,k,F){let V={},Y=v.attributes,z=0,K=k.getAttributes();for(let H in K)if(K[H].location>=0){let ct=Y[H];ct===void 0&&(H==="instanceMatrix"&&g.instanceMatrix&&(ct=g.instanceMatrix),H==="instanceColor"&&g.instanceColor&&(ct=g.instanceColor));let gt={};gt.attribute=ct,ct&&ct.data&&(gt.data=ct.data),V[H]=gt,z++}r.attributes=V,r.attributesNum=z,r.index=F}function y(){let g=r.newAttributes;for(let v=0,k=g.length;v<k;v++)g[v]=0}function d(g){u(g,0)}function u(g,v){let k=r.newAttributes,F=r.enabledAttributes,V=r.attributeDivisors;k[g]=1,F[g]===0&&(i.enableVertexAttribArray(g),F[g]=1),V[g]!==v&&(i.vertexAttribDivisor(g,v),V[g]=v)}function b(){let g=r.newAttributes,v=r.enabledAttributes;for(let k=0,F=v.length;k<F;k++)v[k]!==g[k]&&(i.disableVertexAttribArray(k),v[k]=0)}function M(g,v,k,F,V,Y,z){z===!0?i.vertexAttribIPointer(g,v,k,V,Y):i.vertexAttribPointer(g,v,k,F,V,Y)}function E(g,v,k,F){y();let V=F.attributes,Y=k.getAttributes(),z=v.defaultAttributeValues;for(let K in Y){let H=Y[K];if(H.location>=0){let ot=V[K];if(ot===void 0&&(K==="instanceMatrix"&&g.instanceMatrix&&(ot=g.instanceMatrix),K==="instanceColor"&&g.instanceColor&&(ot=g.instanceColor)),ot!==void 0){let ct=ot.normalized,gt=ot.itemSize,kt=t.get(ot);if(kt===void 0)continue;let qt=kt.buffer,G=kt.type,J=kt.bytesPerElement,pt=G===i.INT||G===i.UNSIGNED_INT||ot.gpuType===Eo;if(ot.isInterleavedBufferAttribute){let lt=ot.data,Tt=lt.stride,yt=ot.offset;if(lt.isInstancedInterleavedBuffer){for(let Dt=0;Dt<H.locationSize;Dt++)u(H.location+Dt,lt.meshPerAttribute);g.isInstancedMesh!==!0&&F._maxInstanceCount===void 0&&(F._maxInstanceCount=lt.meshPerAttribute*lt.count)}else for(let Dt=0;Dt<H.locationSize;Dt++)d(H.location+Dt);i.bindBuffer(i.ARRAY_BUFFER,qt);for(let Dt=0;Dt<H.locationSize;Dt++)M(H.location+Dt,gt/H.locationSize,G,ct,Tt*J,(yt+gt/H.locationSize*Dt)*J,pt)}else{if(ot.isInstancedBufferAttribute){for(let lt=0;lt<H.locationSize;lt++)u(H.location+lt,ot.meshPerAttribute);g.isInstancedMesh!==!0&&F._maxInstanceCount===void 0&&(F._maxInstanceCount=ot.meshPerAttribute*ot.count)}else for(let lt=0;lt<H.locationSize;lt++)d(H.location+lt);i.bindBuffer(i.ARRAY_BUFFER,qt);for(let lt=0;lt<H.locationSize;lt++)M(H.location+lt,gt/H.locationSize,G,ct,gt*J,gt/H.locationSize*lt*J,pt)}}else if(z!==void 0){let ct=z[K];if(ct!==void 0)switch(ct.length){case 2:i.vertexAttrib2fv(H.location,ct);break;case 3:i.vertexAttrib3fv(H.location,ct);break;case 4:i.vertexAttrib4fv(H.location,ct);break;default:i.vertexAttrib1fv(H.location,ct)}}}}b()}function B(){O();for(let g in n){let v=n[g];for(let k in v){let F=v[k];for(let V in F)h(F[V].object),delete F[V];delete v[k]}delete n[g]}}function C(g){if(n[g.id]===void 0)return;let v=n[g.id];for(let k in v){let F=v[k];for(let V in F)h(F[V].object),delete F[V];delete v[k]}delete n[g.id]}function w(g){for(let v in n){let k=n[v];if(k[g.id]===void 0)continue;let F=k[g.id];for(let V in F)h(F[V].object),delete F[V];delete k[g.id]}}function O(){Z(),a=!0,r!==s&&(r=s,l(r.object))}function Z(){s.geometry=null,s.program=null,s.wireframe=!1}return{setup:o,reset:O,resetDefaultState:Z,dispose:B,releaseStatesOfGeometry:C,releaseStatesOfProgram:w,initAttributes:y,enableAttribute:d,disableUnusedAttributes:b}}function rp(i,t,e){let n;function s(l){n=l}function r(l,h){i.drawArrays(n,l,h),e.update(h,n,1)}function a(l,h,p){p!==0&&(i.drawArraysInstanced(n,l,h,p),e.update(h,n,p))}function o(l,h,p){if(p===0)return;t.get("WEBGL_multi_draw").multiDrawArraysWEBGL(n,l,0,h,0,p);let m=0;for(let _=0;_<p;_++)m+=h[_];e.update(m,n,1)}function c(l,h,p,f){if(p===0)return;let m=t.get("WEBGL_multi_draw");if(m===null)for(let _=0;_<l.length;_++)a(l[_],h[_],f[_]);else{m.multiDrawArraysInstancedWEBGL(n,l,0,h,0,f,0,p);let _=0;for(let y=0;y<p;y++)_+=h[y];for(let y=0;y<f.length;y++)e.update(_,n,f[y])}}this.setMode=s,this.render=r,this.renderInstances=a,this.renderMultiDraw=o,this.renderMultiDrawInstances=c}function ap(i,t,e,n){let s;function r(){if(s!==void 0)return s;if(t.has("EXT_texture_filter_anisotropic")===!0){let w=t.get("EXT_texture_filter_anisotropic");s=i.getParameter(w.MAX_TEXTURE_MAX_ANISOTROPY_EXT)}else s=0;return s}function a(w){return!(w!==Ge&&n.convert(w)!==i.getParameter(i.IMPLEMENTATION_COLOR_READ_FORMAT))}function o(w){let O=w===qi&&(t.has("EXT_color_buffer_half_float")||t.has("EXT_color_buffer_float"));return!(w!==ln&&n.convert(w)!==i.getParameter(i.IMPLEMENTATION_COLOR_READ_TYPE)&&w!==Ye&&!O)}function c(w){if(w==="highp"){if(i.getShaderPrecisionFormat(i.VERTEX_SHADER,i.HIGH_FLOAT).precision>0&&i.getShaderPrecisionFormat(i.FRAGMENT_SHADER,i.HIGH_FLOAT).precision>0)return"highp";w="mediump"}return w==="mediump"&&i.getShaderPrecisionFormat(i.VERTEX_SHADER,i.MEDIUM_FLOAT).precision>0&&i.getShaderPrecisionFormat(i.FRAGMENT_SHADER,i.MEDIUM_FLOAT).precision>0?"mediump":"lowp"}let l=e.precision!==void 0?e.precision:"highp",h=c(l);h!==l&&(console.warn("THREE.WebGLRenderer:",l,"not supported, using",h,"instead."),l=h);let p=e.logarithmicDepthBuffer===!0,f=e.reverseDepthBuffer===!0&&t.has("EXT_clip_control");if(f===!0){let w=t.get("EXT_clip_control");w.clipControlEXT(w.LOWER_LEFT_EXT,w.ZERO_TO_ONE_EXT)}let m=i.getParameter(i.MAX_TEXTURE_IMAGE_UNITS),_=i.getParameter(i.MAX_VERTEX_TEXTURE_IMAGE_UNITS),y=i.getParameter(i.MAX_TEXTURE_SIZE),d=i.getParameter(i.MAX_CUBE_MAP_TEXTURE_SIZE),u=i.getParameter(i.MAX_VERTEX_ATTRIBS),b=i.getParameter(i.MAX_VERTEX_UNIFORM_VECTORS),M=i.getParameter(i.MAX_VARYING_VECTORS),E=i.getParameter(i.MAX_FRAGMENT_UNIFORM_VECTORS),B=_>0,C=i.getParameter(i.MAX_SAMPLES);return{isWebGL2:!0,getMaxAnisotropy:r,getMaxPrecision:c,textureFormatReadable:a,textureTypeReadable:o,precision:l,logarithmicDepthBuffer:p,reverseDepthBuffer:f,maxTextures:m,maxVertexTextures:_,maxTextureSize:y,maxCubemapSize:d,maxAttributes:u,maxVertexUniforms:b,maxVaryings:M,maxFragmentUniforms:E,vertexTextures:B,maxSamples:C}}function op(i){let t=this,e=null,n=0,s=!1,r=!1,a=new rn,o=new It,c={value:null,needsUpdate:!1};this.uniform=c,this.numPlanes=0,this.numIntersection=0,this.init=function(p,f){let m=p.length!==0||f||n!==0||s;return s=f,n=p.length,m},this.beginShadows=function(){r=!0,h(null)},this.endShadows=function(){r=!1},this.setGlobalState=function(p,f){e=h(p,f,0)},this.setState=function(p,f,m){let _=p.clippingPlanes,y=p.clipIntersection,d=p.clipShadows,u=i.get(p);if(!s||_===null||_.length===0||r&&!d)r?h(null):l();else{let b=r?0:n,M=b*4,E=u.clippingState||null;c.value=E,E=h(_,f,M,m);for(let B=0;B!==M;++B)E[B]=e[B];u.clippingState=E,this.numIntersection=y?this.numPlanes:0,this.numPlanes+=b}};function l(){c.value!==e&&(c.value=e,c.needsUpdate=n>0),t.numPlanes=n,t.numIntersection=0}function h(p,f,m,_){let y=p!==null?p.length:0,d=null;if(y!==0){if(d=c.value,_!==!0||d===null){let u=m+y*4,b=f.matrixWorldInverse;o.getNormalMatrix(b),(d===null||d.length<u)&&(d=new Float32Array(u));for(let M=0,E=m;M!==y;++M,E+=4)a.copy(p[M]).applyMatrix4(b,o),a.normal.toArray(d,E),d[E+3]=a.constant}c.value=d,c.needsUpdate=!0}return t.numPlanes=y,t.numIntersection=0,d}}function cp(i){let t=new WeakMap;function e(a,o){return o===ga?a.mapping=bi:o===Aa&&(a.mapping=Ei),a}function n(a){if(a&&a.isTexture){let o=a.mapping;if(o===ga||o===Aa)if(t.has(a)){let c=t.get(a).texture;return e(c,a.mapping)}else{let c=a.image;if(c&&c.height>0){let l=new Ja(c.height);return l.fromEquirectangularTexture(i,a),t.set(a,l),a.addEventListener("dispose",s),e(l.texture,a.mapping)}else return null}}return a}function s(a){let o=a.target;o.removeEventListener("dispose",s);let c=t.get(o);c!==void 0&&(t.delete(o),c.dispose())}function r(){t=new WeakMap}return{get:n,dispose:r}}function lp(i){let t=[],e=[],n=[],s=i,r=i-_i+1+Fc.length;for(let a=0;a<r;a++){let o=Math.pow(2,s);e.push(o);let c=1/o;a>i-_i?c=Fc[a-i+_i-1]:a===0&&(c=0),n.push(c);let l=1/(o-2),h=-l,p=1+l,f=[h,h,p,h,p,p,h,h,p,p,h,p],m=6,_=6,y=3,d=2,u=1,b=new Float32Array(y*_*m),M=new Float32Array(d*_*m),E=new Float32Array(u*_*m);for(let C=0;C<m;C++){let w=C%3*2/3-1,O=C>2?0:-1,Z=[w,O,0,w+2/3,O,0,w+2/3,O+1,0,w,O,0,w+2/3,O+1,0,w,O+1,0];b.set(Z,y*_*C),M.set(f,d*_*C);let g=[C,C,C,C,C,C];E.set(g,u*_*C)}let B=new Jn;B.setAttribute("position",new Be(b,y)),B.setAttribute("uv",new Be(M,d)),B.setAttribute("faceIndex",new Be(E,u)),t.push(B),s>_i&&s--}return{lodPlanes:t,sizeLods:e,sigmas:n}}function zc(i,t,e){let n=new hn(i,t,e);return n.texture.mapping=er,n.texture.name="PMREM.cubeUv",n.scissorTest=!0,n}function ys(i,t,e,n,s){i.viewport.set(t,e,n,s),i.scissor.set(t,e,n,s)}function hp(i,t,e){let n=new Float32Array(qn),s=new L(0,1,0);return new Ze({name:"SphericalGaussianBlur",defines:{n:qn,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Uo(),fragmentShader:`
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function jc(){return new Ze({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Uo(),fragmentShader:`
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function Hc(){return new Ze({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Uo(),fragmentShader:`
	...
	`}function up(i){let t=new WeakMap,e=null;function n(o){if(o&&o.isTexture){let c=o.mapping,l=c===ga||c===Aa,h=c===bi||c===Ei;if(l||h){let p=t.get(o),f=p!==void 0?p.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return e===null&&(e=new Ws(i)),p=l?e.fromEquirectangular(o,p):e.fromCubemap(o,p),p.texture.pmremVersion=o.pmremVersion,t.set(o,p),p.texture;if(p!==void 0)return p.texture;{let m=o.image;return l&&m&&m.height>0||h&&m&&s(m)?(e===null&&(e=new Ws(i)),p=l?e.fromEquirectangular(o):e.fromCubemap(o),p.texture.pmremVersion=o.pmremVersion,t.set(o,p),o.addEventListener("dispose",r),p.texture):null}}}return o}function s(o){let c=0,l=6;for(let h=0;h<l;h++)o[h]!==void 0&&c++;return c===l}function r(o){let c=o.target;c.removeEventListener("dispose",r);let l=t.get(c);l!==void 0&&(t.delete(c),l.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:a}}function dp(i){let t={};function e(n){if(t[n]!==void 0)return t[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return t[n]=s,s}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){let s=e(n);return s===null&&Is("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function fp(i,t,e,n){let s={},r=new WeakMap;function a(p){let f=p.target;f.index!==null&&t.remove(f.index);for(let _ in f.attributes)t.remove(f.attributes[_]);for(let _ in f.morphAttributes){let y=f.morphAttributes[_];for(let d=0,u=y.length;d<u;d++)t.remove(y[d])}f.removeEventListener("dispose",a),delete s[f.id];let m=r.get(f);m&&(t.remove(m),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function o(p,f){return s[f.id]===!0||(f.addEventListener("dispose",a),s[f.id]=!0,e.memory.geometries++),f}function c(p){let f=p.attributes;for(let _ in f)t.update(f[_],i.ARRAY_BUFFER);let m=p.morphAttributes;for(let _ in m){let y=m[_];for(let d=0,u=y.length;d<u;d++)t.update(y[d],i.ARRAY_BUFFER)}}function l(p){let f=[],m=p.index,_=p.attributes.position,y=0;if(m!==null){let b=m.array;y=m.version;for(let M=0,E=b.length;M<E;M+=3){let B=b[M+0],C=b[M+1],w=b[M+2];f.push(B,C,C,w,w,B)}}else if(_!==void 0){let b=_.array;y=_.version;for(let M=0,E=b.length/3-1;M<E;M+=3){let B=M+0,C=M+1,w=M+2;f.push(B,C,C,w,w,B)}}else return;let d=new(El(f)?Hs:js)(f,1);d.version=y;let u=r.get(p);u&&t.remove(u),r.set(p,d)}function h(p){let f=r.get(p);if(f){let m=p.index;m!==null&&f.version<m.version&&l(p)}else l(p);return r.get(p)}return{get:o,update:c,getWireframeAttribute:h}}function pp(i,t,e){let n;function s(f){n=f}let r,a;function o(f){r=f.type,a=f.bytesPerElement}function c(f,m){i.drawElements(n,m,r,f*a),e.update(m,n,1)}function l(f,m,_){_!==0&&(i.drawElementsInstanced(n,m,r,f*a,_),e.update(m,n,_))}function h(f,m,_){if(_===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,r,f,0,_);let d=0;for(let u=0;u<_;u++)d+=m[u];e.update(d,n,1)}function p(f,m,_,y){if(_===0)return;let d=t.get("WEBGL_multi_draw");if(d===null)for(let u=0;u<f.length;u++)l(f[u]/a,m[u],y[u]);else{d.multiDrawElementsInstancedWEBGL(n,m,0,r,f,0,y,0,_);let u=0;for(let b=0;b<_;b++)u+=m[b];for(let b=0;b<y.length;b++)e.update(u,n,y[b])}}this.setMode=s,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=p}function mp(i){let t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(e.calls++,a){case i.TRIANGLES:e.triangles+=o*(r/3);break;case i.LINES:e.lines+=o*(r/2);break;case i.LINE_STRIP:e.lines+=o*(r-1);break;case i.LINE_LOOP:e.lines+=o*r;break;case i.POINTS:e.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:n}}function gp(i,t,e){let n=new WeakMap,s=new $t;function r(a,o,c){let l=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,p=h!==void 0?h.length:0,f=n.get(o);if(f===void 0||f.count!==p){let Z=function(){w.dispose(),n.delete(o),o.removeEventListener("dispose",Z)};f!==void 0&&f.texture.dispose();let m=o.morphAttributes.position!==void 0,_=o.morphAttributes.normal!==void 0,y=o.morphAttributes.color!==void 0,d=o.morphAttributes.position||[],u=o.morphAttributes.normal||[],b=o.morphAttributes.color||[],M=0;m===!0&&(M=1),_===!0&&(M=2),y===!0&&(M=3);let E=o.attributes.position.count*M,B=1;E>t.maxTextureSize&&(B=Math.ceil(E/t.maxTextureSize),E=t.maxTextureSize);let C=new Float32Array(E*B*4*p),w=new Os(C,E,B,p);w.type=Ye,w.needsUpdate=!0;let O=M*4;for(let g=0;g<p;g++){let v=d[g],k=u[g],F=b[g],V=E*B*4*g;for(let Y=0;Y<v.count;Y++){let z=Y*O;m===!0&&(s.fromBufferAttribute(v,Y),C[V+z+0]=s.x,C[V+z+1]=s.y,C[V+z+2]=s.z,C[V+z+3]=0),_===!0&&(s.fromBufferAttribute(k,Y),C[V+z+4]=s.x,C[V+z+5]=s.y,C[V+z+6]=s.z,C[V+z+7]=0),y===!0&&(s.fromBufferAttribute(F,Y),C[V+z+8]=s.x,C[V+z+9]=s.y,C[V+z+10]=s.z,C[V+z+11]=F.itemSize===4?s.w:1)}}f={count:p,texture:w,size:new jt(E,B)},n.set(o,f),o.addEventListener("dispose",Z)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,e);else{let m=0;for(let y=0;y<l.length;y++)m+=l[y];let _=o.morphTargetsRelative?1:1-m;c.getUniforms().setValue(i,"morphTargetBaseInfluence",_),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",f.texture,e),c.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:r}}function Ap(i,t,e,n){let s=new WeakMap;function r(c){let l=n.render.frame,h=c.geometry,p=t.get(c,h);if(s.get(p)!==l&&(t.update(p),s.set(p,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),s.get(c)!==l&&(e.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&e.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){let f=c.skeleton;s.get(f)!==l&&(f.update(),s.set(f,l))}return p}function a(){s=new WeakMap}function o(c){let l=c.target;l.removeEventListener("dispose",o),e.remove(l.instanceMatrix),l.instanceColor!==null&&e.remove(l.instanceColor)}return{update:r,dispose:a}}function Ii(i,t,e){let n=i[0];if(n<=0||n>0)return i;let s=t*e,r=Gc[s];if(r===void 0&&(r=new Float32Array(s),Gc[s]=r),t!==0){n.toArray(r,0);for(let a=1,o=0;a!==t;++a)o+=e,i[a].toArray(r,o)}return r}function le(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function he(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function ir(i,t){let e=Wc[t];e===void 0&&(e=new Int32Array(t),Wc[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function _p(i,t){let e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function xp(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(le(e,t))return;i.uniform2fv(this.addr,t),he(e,t)}}function vp(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(le(e,t))return;i.uniform3fv(this.addr,t),he(e,t)}}function yp(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(le(e,t))return;i.uniform4fv(this.addr,t),he(e,t)}}function Mp(i,t){let e=this.cache,n=t.elements;if(n===void 0){if(le(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),he(e,t)}else{if(le(e,n))return;Yc.set(n),i.uniformMatrix2fv(this.addr,!1,Yc),he(e,n)}}function Sp(i,t){let e=this.cache,n=t.elements;if(n===void 0){if(le(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),he(e,t)}else{if(le(e,n))return;Xc.set(n),i.uniformMatrix3fv(this.addr,!1,Xc),he(e,n)}}function bp(i,t){let e=this.cache,n=t.elements;if(n===void 0){if(le(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),he(e,t)}else{if(le(e,n))return;qc.set(n),i.uniformMatrix4fv(this.addr,!1,qc),he(e,n)}}function Ep(i,t){let e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function wp(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(le(e,t))return;i.uniform2iv(this.addr,t),he(e,t)}}function Tp(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(le(e,t))return;i.uniform3iv(this.addr,t),he(e,t)}}function Rp(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(le(e,t))return;i.uniform4iv(this.addr,t),he(e,t)}}function Cp(i,t){let e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function Ip(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(le(e,t))return;i.uniform2uiv(this.addr,t),he(e,t)}}function Pp(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(le(e,t))return;i.uniform3uiv(this.addr,t),he(e,t)}}function Lp(i,t){let e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(le(e,t))return;i.uniform4uiv(this.addr,t),he(e,t)}}function Up(i,t,e){let n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(Vc.compareFunction=bl,r=Vc):r=Cl,e.setTexture2D(t||r,s)}function Dp(i,t,e){let n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture3D(t||Pl,s)}function Np(i,t,e){let n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTextureCube(t||Ll,s)}function Bp(i,t,e){let n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture2DArray(t||Il,s)}function Fp(i){switch(i){case 5126:return _p;case 35664:return xp;case 35665:return vp;case 35666:return yp;case 35674:return Mp;case 35675:return Sp;case 35676:return bp;case 5124:case 35670:return Ep;case 35667:case 35671:return wp;case 35668:case 35672:return Tp;case 35669:case 35673:return Rp;case 5125:return Cp;case 36294:return Ip;case 36295:return Pp;case 36296:return Lp;case 35678:case 36198:case 36298:case 36306:case 35682:return Up;case 35679:case 36299:case 36307:return Dp;case 35680:case 36300:case 36308:case 36293:return Np;case 36289:case 36303:case 36311:case 36292:return Bp}}function Op(i,t){i.uniform1fv(this.addr,t)}function kp(i,t){let e=Ii(t,this.size,2);i.uniform2fv(this.addr,e)}function zp(i,t){let e=Ii(t,this.size,3);i.uniform3fv(this.addr,e)}function jp(i,t){let e=Ii(t,this.size,4);i.uniform4fv(this.addr,e)}function Hp(i,t){let e=Ii(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function Vp(i,t){let e=Ii(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function Gp(i,t){let e=Ii(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function Wp(i,t){i.uniform1iv(this.addr,t)}function qp(i,t){i.uniform2iv(this.addr,t)}function Xp(i,t){i.uniform3iv(this.addr,t)}function Yp(i,t){i.uniform4iv(this.addr,t)}function $p(i,t){i.uniform1uiv(this.addr,t)}function Zp(i,t){i.uniform2uiv(this.addr,t)}function Kp(i,t){i.uniform3uiv(this.addr,t)}function Jp(i,t){i.uniform4uiv(this.addr,t)}function Qp(i,t,e){let n=this.cache,s=t.length,r=ir(e,s);le(n,r)||(i.uniform1iv(this.addr,r),he(n,r));for(let a=0;a!==s;++a)e.setTexture2D(t[a]||Cl,r[a])}function tm(i,t,e){let n=this.cache,s=t.length,r=ir(e,s);le(n,r)||(i.uniform1iv(this.addr,r),he(n,r));for(let a=0;a!==s;++a)e.setTexture3D(t[a]||Pl,r[a])}function em(i,t,e){let n=this.cache,s=t.length,r=ir(e,s);le(n,r)||(i.uniform1iv(this.addr,r),he(n,r));for(let a=0;a!==s;++a)e.setTextureCube(t[a]||Ll,r[a])}function nm(i,t,e){let n=this.cache,s=t.length,r=ir(e,s);le(n,r)||(i.uniform1iv(this.addr,r),he(n,r));for(let a=0;a!==s;++a)e.setTexture2DArray(t[a]||Il,r[a])}function im(i){switch(i){case 5126:return Op;case 35664:return kp;case 35665:return zp;case 35666:return jp;case 35674:return Hp;case 35675:return Vp;case 35676:return Gp;case 5124:case 35670:return Wp;case 35667:case 35671:return qp;case 35668:case 35672:return Xp;case 35669:case 35673:return Yp;case 5125:return $p;case 36294:return Zp;case 36295:return Kp;case 36296:return Jp;case 35678:case 36198:case 36298:case 36306:case 35682:return Qp;case 35679:case 36299:case 36307:return tm;case 35680:case 36300:case 36308:case 36293:return em;case 36289:case 36303:case 36311:case 36292:return nm}}function $c(i,t){i.seq.push(t),i.map[t.id]=t}function sm(i,t,e){let n=i.name,s=n.length;for(sa.lastIndex=0;;){let r=sa.exec(n),a=sa.lastIndex,o=r[1],c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===s){$c(e,l===void 0?new to(o,i,t):new eo(o,i,t));break}else{let p=e.map[o];p===void 0&&(p=new no(o),$c(e,p)),e=p}}}function Zc(i,t,e){let n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}function om(i,t){let e=i.split(`
`),n=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let a=s;a<r;a++){let o=a+1;n.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return n.join(`
`)}function cm(i){let t=Wt.getPrimaries(Wt.workingColorSpace),e=Wt.getPrimaries(i),n;switch(t===e?n="":t===Ds&&e===Us?n="LinearDisplayP3ToLinearSRGB":t===Us&&e===Ds&&(n="LinearSRGBToLinearDisplayP3"),i){case Un:case nr:return[n,"LinearTransferOETF"];case Ee:case Lo:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function Kc(i,t,e){let n=i.getShaderParameter(t,i.COMPILE_STATUS),s=i.getShaderInfoLog(t).trim();if(n&&s==="")return"";let r=/ERROR: 0:(\d+)/.exec(s);if(r){let a=parseInt(r[1]);return e.toUpperCase()+`

`+s+`

`+om(i.getShaderSource(t),a)}else return s}function lm(i,t){let e=cm(t);return`vec4 ${i}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function hm(i,t){let e;switch(t){case Uh:e="Linear";break;case Dh:e="Reinhard";break;case Nh:e="Cineon";break;case Bh:e="ACESFilmic";break;case Oh:e="AgX";break;case kh:e="Neutral";break;case Fh:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}function um(){Wt.getLuminanceCoefficients(Ms);let i=Ms.x.toFixed(4),t=Ms.y.toFixed(4),e=Ms.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function pm(i,t){let e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){let r=i.getActiveAttrib(t,s),a=r.name,o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),e[a]={type:r.type,location:i.getAttribLocation(t,a),locationSize:o}}return e}function zi(i){return i!==""}function Jc(i,t){let e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Qc(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}function io(i){return i.replace(mm,Am)}function Am(i,t){let e=Ct[t];if(e===void 0){let n=gm.get(t);if(n!==void 0)e=Ct[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return io(e)}function tl(i){return i.replace(_m,xm)}function xm(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function el(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function vm(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===ul?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===dh?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===sn&&(t="SHADOWMAP_TYPE_VSM"),t}function ym(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case bi:case Ei:t="ENVMAP_TYPE_CUBE";break;case er:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Mm(i){let t="ENVMAP_MODE_REFLECTION";return i.envMap&&i.envMapMode===Ei&&(t="ENVMAP_MODE_REFRACTION"),t}function Sm(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case dl:t="ENVMAP_BLENDING_MULTIPLY";break;case Ph:t="ENVMAP_BLENDING_MIX";break;case Lh:t="ENVMAP_BLENDING_ADD";break}return t}function bm(i){let t=i.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function Em(i,t,e,n){let s=i.getContext(),r=e.defines,a=e.vertexShader,o=e.fragmentShader,c=vm(e),l=ym(e),h=Mm(e),p=Sm(e),f=bm(e),m=dm(e),_=fm(r),y=s.createProgram(),d,u,b=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+u);let M=b+d+a,E=b+u+o,B=Zc(s,s.VERTEX_SHADER,M),C=Zc(s,s.FRAGMENT_SHADER,E);s.attachShader(y,B),s.attachShader(y,C),e.index0AttributeName!==void 0?s.bindAttribLocation(y,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function w(v){if(i.debug.checkShaderErrors){let k=s.getProgramInfoLog(y).trim(),F=s.getShaderInfoLog(B).trim(),V=s.getShaderInfoLog(C).trim(),Y=!0,z=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(Y=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,y,B,C);else{let K=Kc(s,B,"vertex"),H=Kc(s,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
}`,lo=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,n){if(this.texture===null){let s=new Ce,r=t.properties.get(s);r.__webglTexture=e.texture,(e.depthNear!=n.depthNear||e.depthFar!=n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){let e=t.cameras[0].viewport,n=new Ze({vertexShader:qm,fragmentShader:Xm,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new fe(new Pn(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},ho=class extends Rn{constructor(t,e){super();let n=this,s=null,r=1,a=null,o="local-floor",c=1,l=null,h=null,p=null,f=null,m=null,_=null,y=new lo,d=e.getContextAttributes(),u=null,b=null,M=[],E=[],B=new jt,C=null,w=new ge;w.layers.enable(1),w.viewport=new $t;let O=new ge;O.layers.enable(2),O.viewport=new $t;let Z=[w,O],g=new co;g.layers.enable(1),g.layers.enable(2);let v=null,k=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(G){let J=M[G];return J===void 0&&(J=new ji,M[G]=J),J.getTargetRaySpace()},this.getControllerGrip=function(G){let J=M[G];return J===void 0&&(J=new ji,M[G]=J),J.getGripSpace()},this.getHand=function(G){let J=M[G];return J===void 0&&(J=new ji,M[G]=J),J.getHandSpace()};function F(G){let J=E.indexOf(G.inputSource);if(J===-1)return;let pt=M[J];pt!==void 0&&(pt.update(G.inputSource,G.frame,l||a),pt.dispatchEvent({type:G.type,data:G.inputSource}))}function V(){s.removeEventListener("select",F),s.removeEventListener("selectstart",F),s.removeEventListener("selectend",F),s.removeEventListener("squeeze",F),s.removeEventListener("squeezestart",F),s.removeEventListener("squeezeend",F),s.removeEventListener("end",V),s.removeEventListener("inputsourceschange",Y);for(let G=0;G<M.length;G++){let J=E[G];J!==null&&(E[G]=null,M[G].disconnect(J))}v=null,k=null,y.reset(),t.setRenderTarget(u),m=null,f=null,p=null,s=null,b=null,qt.stop(),n.isPresenting=!1,t.setPixelRatio(C),t.setSize(B.width,B.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(G){r=G,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(G){o=G,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(G){l=G},this.getBaseLayer=function(){return f!==null?f:m},this.getBinding=function(){return p},this.getFrame=function(){return _},this.getSession=function(){return s},this.setSession=async function(G){if(s=G,s!==null){if(u=t.getRenderTarget(),s.addEventListener("select",F),s.addEventListener("selectstart",F),s.addEventListener("selectend",F),s.addEventListener("squeeze",F),s.addEventListener("squeezestart",F),s.addEventListener("squeezeend",F),s.addEventListener("end",V),s.addEventListener("inputsourceschange",Y),d.xrCompatible!==!0&&await e.makeXRCompatible(),C=t.getPixelRatio(),t.getSize(B),s.renderState.layers===void 0){let J={antialias:d.antialias,alpha:!0,depth:d.depth,stencil:d.stencil,framebufferScaleFactor:r};m=new XRWebGLLayer(s,e,J),s.updateRenderState({baseLayer:m}),t.setPixelRatio(1),t.setSize(m.framebufferWidth,m.framebufferHeight,!1),b=new hn(m.framebufferWidth,m.framebufferHeight,{format:Ge,type:ln,colorSpace:t.outputColorSpace,stencilBuffer:d.stencil})}else{let J=null,pt=null,lt=null;d.depth&&(lt=d.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,J=d.stencil?Ti:vi,pt=d.stencil?wi:$n);let Tt={colorFormat:e.RGBA8,depthFormat:lt,scaleFactor:r};p=new XRWebGLBinding(s,e),f=p.createProjectionLayer(Tt),s.updateRenderState({layers:[f]}),t.setPixelRatio(1),t.setSize(f.textureWidth,f.textureHeight,!1),b=new hn(f.textureWidth,f.textureHeight,{format:Ge,type:ln,depthTexture:new qs(f.textureWidth,f.textureHeight,pt,void 0,void 0,void 0,void 0,void 0,void 0,J),stencilBuffer:d.stencil,colorSpace:t.outputColorSpace,samples:d.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1})}b.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await s.requestReferenceSpace(o),qt.setContext(s),qt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return y.getDepthTexture()};function Y(G){for(let J=0;J<G.removed.length;J++){let pt=G.removed[J],lt=E.indexOf(pt);lt>=0&&(E[lt]=null,M[lt].disconnect(pt))}for(let J=0;J<G.added.length;J++){let pt=G.added[J],lt=E.indexOf(pt);if(lt===-1){for(let yt=0;yt<M.length;yt++)if(yt>=E.length){E.push(pt),lt=yt;break}else if(E[yt]===null){E[yt]=pt,lt=yt;break}if(lt===-1)break}let Tt=M[lt];Tt&&Tt.connect(pt)}}let z=new L,K=new L;function H(G,J,pt){z.setFromMatrixPosition(J.matrixWorld),K.setFromMatrixPosition(pt.matrixWorld);let lt=z.distanceTo(K),Tt=J.projectionMatrix.elements,yt=pt.projectionMatrix.elements,Dt=Tt[14]/(Tt[10]-1),Yt=Tt[14]/(Tt[10]+1),Nt=(Tt[9]+1)/Tt[5],T=(Tt[9]-1)/Tt[5],Pe=(Tt[8]-1)/Tt[0],Lt=(yt[8]+1)/yt[0],Ft=Dt*Pe,St=Dt*Lt,Kt=lt/(-Pe+Lt),wt=Kt*-Pe;if(J.matrixWorld.decompose(G.position,G.quaternion,G.scale),G.translateX(wt),G.translateZ(Kt),G.matrixWorld.compose(G.position,G.quaternion,G.scale),G.matrixWorldInverse.copy(G.matrixWorld).invert(),Tt[10]===-1)G.projectionMatrix.copy(J.projectionMatrix),G.projectionMatrixInverse.copy(J.projectionMatrixInverse);else{let S=Dt+Kt,A=Yt+Kt,U=Ft-wt,q=St+(lt-wt),$=Nt*Yt/A*S,W=T*Yt/A*S;G.projectionMatrix.makePerspective(U,q,$,W,S,A),G.projectionMatrixInverse.copy(G.projectionMatrix).invert()}}function ot(G,J){J===null?G.matrixWorld.copy(G.matrix):G.matrixWorld.multiplyMatrices(J.matrixWorld,G.matrix),G.matrixWorldInverse.copy(G.matrixWorld).invert()}this.updateCamera=function(G){if(s===null)return;let J=G.near,pt=G.far;y.texture!==null&&(y.depthNear>0&&(J=y.depthNear),y.depthFar>0&&(pt=y.depthFar)),g.near=O.near=w.near=J,g.far=O.far=w.far=pt,(v!==g.near||k!==g.far)&&(s.updateRenderState({depthNear:g.near,depthFar:g.far}),v=g.near,k=g.far);let lt=G.parent,Tt=g.cameras;ot(g,lt);for(let yt=0;yt<Tt.length;yt++)ot(Tt[yt],lt);Tt.length===2?H(g,w,O):g.projectionMatrix.copy(w.projectionMatrix),ct(G,g,lt)};function ct(G,J,pt){pt===null?G.matrix.copy(J.matrixWorld):(G.matrix.copy(pt.matrixWorld),G.matrix.invert(),G.matrix.multiply(J.matrixWorld)),G.matrix.decompose(G.position,G.quaternion,G.scale),G.updateMatrixWorld(!0),G.projectionMatrix.copy(J.projectionMatrix),G.projectionMatrixInverse.copy(J.projectionMatrixInverse),G.isPerspectiveCamera&&(G.fov=qa*2*Math.atan(1/G.projectionMatrix.elements[5]),G.zoom=1)}this.getCamera=function(){return g},this.getFoveation=function(){if(!(f===null&&m===null))return c},this.setFoveation=function(G){c=G,f!==null&&(f.fixedFoveation=G),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=G)},this.hasDepthSensing=function(){return y.texture!==null},this.getDepthSensingMesh=function(){return y.getMesh(g)};let gt=null;function kt(G,J){if(h=J.getViewerPose(l||a),_=J,h!==null){let pt=h.views;m!==null&&(t.setRenderTargetFramebuffer(b,m.framebuffer),t.setRenderTarget(b));let lt=!1;pt.length!==g.cameras.length&&(g.cameras.length=0,lt=!0);for(let yt=0;yt<pt.length;yt++){let Dt=pt[yt],Yt=null;if(m!==null)Yt=m.getViewport(Dt);else{let T=p.getViewSubImage(f,Dt);Yt=T.viewport,yt===0&&(t.setRenderTargetTextures(b,T.colorTexture,f.ignoreDepthValues?void 0:T.depthStencilTexture),t.setRenderTarget(b))}let Nt=Z[yt];Nt===void 0&&(Nt=new ge,Nt.layers.enable(yt),Nt.viewport=new $t,Z[yt]=Nt),Nt.matrix.fromArray(Dt.transform.matrix),Nt.matrix.decompose(Nt.position,Nt.quaternion,Nt.scale),Nt.projectionMatrix.fromArray(Dt.projectionMatrix),Nt.projectionMatrixInverse.copy(Nt.projectionMatrix).invert(),Nt.viewport.set(Yt.x,Yt.y,Yt.width,Yt.height),yt===0&&(g.matrix.copy(Nt.matrix),g.matrix.decompose(g.position,g.quaternion,g.scale)),lt===!0&&g.cameras.push(Nt)}let Tt=s.enabledFeatures;if(Tt&&Tt.includes("depth-sensing")){let yt=p.getDepthInformation(pt[0]);yt&&yt.isValid&&yt.texture&&y.init(t,yt,s.renderState)}}for(let pt=0;pt<M.length;pt++){let lt=E[pt],Tt=M[pt];lt!==null&&Tt!==void 0&&Tt.update(lt,J,l||a)}gt&&gt(G,J),J.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:J}),_=null}let qt=new Rl;qt.setAnimationLoop(kt),this.setAnimationLoop=function(G){gt=G},this.dispose=function(){}}},Hn=new $e,Ym=new te;Xs=class{constructor(t={}){let{canvas:e=Jh(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:p=!1}=t;this.isWebGLRenderer=!0;let f;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");f=n.getContextAttributes().alpha}else f=a;let m=new Uint32Array(4),_=new Int32Array(4),y=null,d=null,u=[],b=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Ee,this.toneMapping=En,this.toneMappingExposure=1;let M=this,E=!1,B=0,C=0,w=null,O=-1,Z=null,g=new $t,v=new $t,k=null,F=new Pt(0),V=0,Y=e.width,z=e.height,K=1,H=null,ot=null,ct=new $t(0,0,Y,z),gt=new $t(0,0,Y,z),kt=!1,qt=new Vi,G=!1,J=!1,pt=new te,lt=new te,Tt=new L,yt=new $t,Dt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Yt=!1;function Nt(){return w===null?K:1}let T=n;function Pe(x,I){return e.getContext(x,I)}try{let x={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:h,failIfMajorPerformanceCaveat:p};if("setAttribute"in e&&e.setAttribute("data-engine","three.js r169"),e.addEventListener("webglcontextlost",X,!1),e.addEventListener("webglcontextrestored",it,!1),e.addEventListener("webglcontextcreationerror",at,!1),T===null){let I="webgl2";if(T=Pe(I,x),T===null)throw Pe(I)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(x){throw console.error("THREE.WebGLRenderer: "+x.message),x}let Lt,Ft,St,Kt,wt,S,A,U,q,$,W,At,nt,ht,Ot,Q,ut,bt,Et,dt,Ut,Rt,Zt,R;function rt(){Lt=new dp(T),Lt.init(),Rt=new Gm(T,Lt),Ft=new ap(T,Lt,t,Rt),St=new jm(T),Ft.reverseDepthBuffer&&St.buffers.depth.setReversed(!0),Kt=new mp(T),wt=new Rm,S=new Vm(T,Lt,St,wt,Ft,Rt,Kt),A=new cp(M),U=new up(M),q=new yu(T),Zt=new sp(T,q),$=new fp(T,q,Kt,Zt),W=new Ap(T,$,q,Kt),Et=new gp(T,Ft,S),Q=new op(wt),At=new Tm(M,A,U,Lt,Ft,Zt,Q),nt=new $m(M,wt),ht=new Im,Ot=new Bm(Lt),bt=new ip(M,A,U,St,W,f,c),ut=new km(M,W,Ft),R=new Zm(T,Kt,Ft,St),dt=new rp(T,Lt,Kt),Ut=new pp(T,Lt,Kt),Kt.programs=At.programs,M.capabilities=Ft,M.extensions=Lt,M.properties=wt,M.renderLists=ht,M.shadowMap=ut,M.state=St,M.info=Kt}rt();let j=new ho(M,T);this.xr=j,this.getContext=function(){return T},this.getContextAttributes=function(){return T.getContextAttributes()},this.forceContextLoss=function(){let x=Lt.get("WEBGL_lose_context");x&&x.loseContext()},this.forceContextRestore=function(){let x=Lt.get("WEBGL_lose_context");x&&x.restoreContext()},this.getPixelRatio=function(){return K},this.setPixelRatio=function(x){x!==void 0&&(K=x,this.setSize(Y,z,!1))},this.getSize=function(x){return x.set(Y,z)},this.setSize=function(x,I,D=!0){if(j.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}Y=x,z=I,e.width=Math.floor(x*K),e.height=Math.floor(I*K),D===!0&&(e.style.width=x+"px",e.style.height=I+"px"),this.setViewport(0,0,x,I)},this.getDrawingBufferSize=function(x){return x.set(Y*K,z*K).floor()},this.setDrawingBufferSize=function(x,I,D){Y=x,z=I,K=D,e.width=Math.floor(x*D),e.height=Math.floor(I*D),this.setViewport(0,0,x,I)},this.getCurrentViewport=function(x){return x.copy(g)},this.getViewport=function(x){return x.copy(ct)},this.setViewport=function(x,I,D,N){x.isVector4?ct.set(x.x,x.y,x.z,x.w):ct.set(x,I,D,N),St.viewport(g.copy(ct).multiplyScalar(K).round())},this.getScissor=function(x){return x.copy(gt)},this.setScissor=function(x,I,D,N){x.isVector4?gt.set(x.x,x.y,x.z,x.w):gt.set(x,I,D,N),St.scissor(v.copy(gt).multiplyScalar(K).round())},this.getScissorTest=function(){return kt},this.setScissorTest=function(x){St.setScissorTest(kt=x)},this.setOpaqueSort=function(x){H=x},this.setTransparentSort=function(x){ot=x},this.getClearColor=function(x){return x.copy(bt.getClearColor())},this.setClearColor=function(){bt.setClearColor.apply(bt,arguments)},this.getClearAlpha=function(){return bt.getClearAlpha()},this.setClearAlpha=function(){bt.setClearAlpha.apply(bt,arguments)},this.clear=function(x=!0,I=!0,D=!0){let N=0;if(x){let P=!1;if(w!==null){let tt=w.texture.format;P=tt===Po||tt===Io||tt===Co}if(P){let tt=w.texture.type,st=tt===ln||tt===$n||tt===Hi||tt===wi||tt===wo||tt===To,ft=bt.getClearColor(),mt=bt.getClearAlpha(),vt=ft.r,Mt=ft.g,_t=ft.b;st?(m[0]=vt,m[1]=Mt,m[2]=_t,m[3]=mt,T.clearBufferuiv(T.COLOR,0,m)):(_[0]=vt,_[1]=Mt,_[2]=_t,_[3]=mt,T.clearBufferiv(T.COLOR,0,_))}else N|=T.COLOR_BUFFER_BIT}I&&(N|=T.DEPTH_BUFFER_BIT,T.clearDepth(this.capabilities.reverseDepthBuffer?0:1)),D&&(N|=T.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),T.clear(N)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",X,!1),e.removeEventListener("webglcontextrestored",it,!1),e.removeEventListener("webglcontextcreationerror",at,!1),ht.dispose(),Ot.dispose(),wt.dispose(),A.dispose(),U.dispose(),W.dispose(),Zt.dispose(),R.dispose(),At.dispose(),j.dispose(),j.removeEventListener("sessionstart",ec),j.removeEventListener("sessionend",nc),Bn.stop()};function X(x){x.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),E=!0}function it(){console.log("THREE.WebGLRenderer: Context Restored."),E=!1;let x=Kt.autoReset,I=ut.enabled,D=ut.autoUpdate,N=ut.needsUpdate,P=ut.type;rt(),Kt.autoReset=x,ut.enabled=I,ut.autoUpdate=D,ut.needsUpdate=N,ut.type=P}function at(x){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",x.statusMessage)}function Bt(x){let I=x.target;I.removeEventListener("dispose",Bt),oe(I)}function oe(x){Me(x),wt.remove(x)}function Me(x){let I=wt.get(x).programs;I!==void 0&&(I.forEach(function(D){At.releaseProgram(D)}),x.isShaderMaterial&&At.releaseShaderCache(x))}this.renderBufferDirect=function(x,I,D,N,P,tt){I===null&&(I=Dt);let st=P.isMesh&&P.matrixWorld.determinant()<0,ft=ih(x,I,D,N,P);St.setMaterial(N,st);let mt=D.index,vt=1;if(N.wireframe===!0){if(mt=$.getWireframeAttribute(D),mt===void 0)return;vt=2}let Mt=D.drawRange,_t=D.attributes.position,Xt=Mt.start*vt,Jt=(Mt.start+Mt.count)*vt;tt!==null&&(Xt=Math.max(Xt,tt.start*vt),Jt=Math.min(Jt,(tt.start+tt.count)*vt)),mt!==null?(Xt=Math.max(Xt,0),Jt=Math.min(Jt,mt.count)):_t!=null&&(Xt=Math.max(Xt,0),Jt=Math.min(Jt,_t.count));let se=Jt-Xt;if(se<0||se===1/0)return;Zt.setup(P,N,ft,D,mt);let Le,Vt=dt;if(mt!==null&&(Le=q.get(mt),Vt=Ut,Vt.setIndex(Le)),P.isMesh)N.wireframe===!0?(St.setLineWidth(N.wireframeLinewidth*Nt()),Vt.setMode(T.LINES)):Vt.setMode(T.TRIANGLES);else if(P.isLine){let xt=N.linewidth;xt===void 0&&(xt=1),St.setLineWidth(xt*Nt()),P.isLineSegments?Vt.setMode(T.LINES):P.isLineLoop?Vt.setMode(T.LINE_LOOP):Vt.setMode(T.LINE_STRIP)}else P.isPoints?Vt.setMode(T.POINTS):P.isSprite&&Vt.setMode(T.TRIANGLES);if(P.isBatchedMesh)if(P._multiDrawInstances!==null)Vt.renderMultiDrawInstances(P._multiDrawStarts,P._multiDrawCounts,P._multiDrawCount,P._multiDrawInstances);else if(Lt.get("WEBGL_multi_draw"))Vt.renderMultiDraw(P._multiDrawStarts,P._multiDrawCounts,P._multiDrawCount);else{let xt=P._multiDrawStarts,de=P._multiDrawCounts,Gt=P._multiDrawCount,ke=mt?q.get(mt).bytesPerElement:1,ni=wt.get(N).currentProgram.getUniforms();for(let Ue=0;Ue<Gt;Ue++)ni.setValue(T,"_gl_DrawID",Ue),Vt.render(xt[Ue]/ke,de[Ue])}else if(P.isInstancedMesh)Vt.renderInstances(Xt,se,P.count);else if(D.isInstancedBufferGeometry){let xt=D._maxInstanceCount!==void 0?D._maxInstanceCount:1/0,de=Math.min(D.instanceCount,xt);Vt.renderInstances(Xt,se,de)}else Vt.render(Xt,se)};function zt(x,I,D){x.transparent===!0&&x.side===an&&x.forceSinglePass===!1?(x.side=Re,x.needsUpdate=!0,es(x,I,D),x.side=wn,x.needsUpdate=!0,es(x,I,D),x.side=an):es(x,I,D)}this.compile=function(x,I,D=null){D===null&&(D=x),d=Ot.get(D),d.init(I),b.push(d),D.traverseVisible(function(P){P.isLight&&P.layers.test(I.layers)&&(d.pushLight(P),P.castShadow&&d.pushShadow(P))}),x!==D&&x.traverseVisible(function(P){P.isLight&&P.layers.test(I.layers)&&(d.pushLight(P),P.castShadow&&d.pushShadow(P))}),d.setupLights();let N=new Set;return x.traverse(function(P){if(!(P.isMesh||P.isPoints||P.isLine||P.isSprite))return;let tt=P.material;if(tt)if(Array.isArray(tt))for(let st=0;st<tt.length;st++){let ft=tt[st];zt(ft,D,P),N.add(ft)}else zt(tt,D,P),N.add(tt)}),b.pop(),d=null,N},this.compileAsync=function(x,I,D=null){let N=this.compile(x,I,D);return new Promise(P=>{function tt(){if(N.forEach(function(st){wt.get(st).currentProgram.isReady()&&N.delete(st)}),N.size===0){P(x);return}setTimeout(tt,10)}Lt.get("KHR_parallel_shader_compile")!==null?tt():setTimeout(tt,10)})};let Se=null;function Ke(x){Se&&Se(x)}function ec(){Bn.stop()}function nc(){Bn.start()}let Bn=new Rl;Bn.setAnimationLoop(Ke),typeof self<"u"&&Bn.setContext(self),this.setAnimationLoop=function(x){Se=x,j.setAnimationLoop(x),x===null?Bn.stop():Bn.start()},j.addEventListener("sessionstart",ec),j.addEventListener("sessionend",nc),this.render=function(x,I){if(I!==void 0&&I.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(E===!0)return;if(x.matrixWorldAutoUpdate===!0&&x.updateMatrixWorld(),I.parent===null&&I.matrixWorldAutoUpdate===!0&&I.updateMatrixWorld(),j.enabled===!0&&j.isPresenting===!0&&(j.cameraAutoUpdate===!0&&j.updateCamera(I),I=j.getCamera()),x.isScene===!0&&x.onBeforeRender(M,x,I,w),d=Ot.get(x,b.length),d.init(I),b.push(d),lt.multiplyMatrices(I.projectionMatrix,I.matrixWorldInverse),qt.setFromProjectionMatrix(lt),J=this.localClippingEnabled,G=Q.init(this.clippingPlanes,J),y=ht.get(x,u.length),y.init(),u.push(y),j.enabled===!0&&j.isPresenting===!0){let tt=M.xr.getDepthSensingMesh();tt!==null&&br(tt,I,-1/0,M.sortObjects)}br(x,I,0,M.sortObjects),y.finish(),M.sortObjects===!0&&y.sort(H,ot),Yt=j.enabled===!1||j.isPresenting===!1||j.hasDepthSensing()===!1,Yt&&bt.addToRenderList(y,x),this.info.render.frame++,G===!0&&Q.beginShadows();let D=d.state.shadowsArray;ut.render(D,x,I),G===!0&&Q.endShadows(),this.info.autoReset===!0&&this.info.reset();let N=y.opaque,P=y.transmissive;if(d.setupLights(),I.isArrayCamera){let tt=I.cameras;if(P.length>0)for(let st=0,ft=tt.length;st<ft;st++){let mt=tt[st];sc(N,P,x,mt)}Yt&&bt.render(x);for(let st=0,ft=tt.length;st<ft;st++){let mt=tt[st];ic(y,x,mt,mt.viewport)}}else P.length>0&&sc(N,P,x,I),Yt&&bt.render(x),ic(y,x,I);w!==null&&(S.updateMultisampleRenderTarget(w),S.updateRenderTargetMipmap(w)),x.isScene===!0&&x.onAfterRender(M,x,I),Zt.resetDefaultState(),O=-1,Z=null,b.pop(),b.length>0?(d=b[b.length-1],G===!0&&Q.setGlobalState(M.clippingPlanes,d.state.camera)):d=null,u.pop(),u.length>0?y=u[u.length-1]:y=null};function br(x,I,D,N){if(x.visible===!1)return;if(x.layers.test(I.layers)){if(x.isGroup)D=x.renderOrder;else if(x.isLOD)x.autoUpdate===!0&&x.update(I);else if(x.isLight)d.pushLight(x),x.castShadow&&d.pushShadow(x);else if(x.isSprite){if(!x.frustumCulled||qt.intersectsSprite(x)){N&&yt.setFromMatrixPosition(x.matrixWorld).applyMatrix4(lt);let st=W.update(x),ft=x.material;ft.visible&&y.push(x,st,ft,D,yt.z,null)}}else if((x.isMesh||x.isLine||x.isPoints)&&(!x.frustumCulled||qt.intersectsObject(x))){let st=W.update(x),ft=x.material;if(N&&(x.boundingSphere!==void 0?(x.boundingSphere===null&&x.computeBoundingSphere(),yt.copy(x.boundingSphere.center)):(st.boundingSphere===null&&st.computeBoundingSphere(),yt.copy(st.boundingSphere.center)),yt.applyMatrix4(x.matrixWorld).applyMatrix4(lt)),Array.isArray(ft)){let mt=st.groups;for(let vt=0,Mt=mt.length;vt<Mt;vt++){let _t=mt[vt],Xt=ft[_t.materialIndex];Xt&&Xt.visible&&y.push(x,st,Xt,D,yt.z,_t)}}else ft.visible&&y.push(x,st,ft,D,yt.z,null)}}let tt=x.children;for(let st=0,ft=tt.length;st<ft;st++)br(tt[st],I,D,N)}function ic(x,I,D,N){let P=x.opaque,tt=x.transmissive,st=x.transparent;d.setupLightsView(D),G===!0&&Q.setGlobalState(M.clippingPlanes,D),N&&St.viewport(g.copy(N)),P.length>0&&ts(P,I,D),tt.length>0&&ts(tt,I,D),st.length>0&&ts(st,I,D),St.buffers.depth.setTest(!0),St.buffers.depth.setMask(!0),St.buffers.color.setMask(!0),St.setPolygonOffset(!1)}function sc(x,I,D,N){if((D.isScene===!0?D.overrideMaterial:null)!==null)return;d.state.transmissionRenderTarget[N.id]===void 0&&(d.state.transmissionRenderTarget[N.id]=new hn(1,1,{generateMipmaps:!0,type:Lt.has("EXT_color_buffer_half_float")||Lt.has("EXT_color_buffer_float")?qi:ln,minFilter:Yn,samples:4,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Wt.workingColorSpace}));let tt=d.state.transmissionRenderTarget[N.id],st=N.viewport||g;tt.setSize(st.z,st.w);let ft=M.getRenderTarget();M.setRenderTarget(tt),M.getClearColor(F),V=M.getClearAlpha(),V<1&&M.setClearColor(16777215,.5),M.clear(),Yt&&bt.render(D);let mt=M.toneMapping;M.toneMapping=En;let vt=N.viewport;if(N.viewport!==void 0&&(N.viewport=void 0),d.setupLightsView(N),G===!0&&Q.setGlobalState(M.clippingPlanes,N),ts(x,D,N),S.updateMultisampleRenderTarget(tt),S.updateRenderTargetMipmap(tt),Lt.has("WEBGL_multisampled_render_to_texture")===!1){let Mt=!1;for(let _t=0,Xt=I.length;_t<Xt;_t++){let Jt=I[_t],se=Jt.object,Le=Jt.geometry,Vt=Jt.material,xt=Jt.group;if(Vt.side===an&&se.layers.test(N.layers)){let de=Vt.side;Vt.side=Re,Vt.needsUpdate=!0,rc(se,D,N,Le,Vt,xt),Vt.side=de,Vt.needsUpdate=!0,Mt=!0}}Mt===!0&&(S.updateMultisampleRenderTarget(tt),S.updateRenderTargetMipmap(tt))}M.setRenderTarget(ft),M.setClearColor(F,V),vt!==void 0&&(N.viewport=vt),M.toneMapping=mt}function ts(x,I,D){let N=I.isScene===!0?I.overrideMaterial:null;for(let P=0,tt=x.length;P<tt;P++){let st=x[P],ft=st.object,mt=st.geometry,vt=N===null?st.material:N,Mt=st.group;ft.layers.test(D.layers)&&rc(ft,I,D,mt,vt,Mt)}}function rc(x,I,D,N,P,tt){x.onBeforeRender(M,I,D,N,P,tt),x.modelViewMatrix.multiplyMatrices(D.matrixWorldInverse,x.matrixWorld),x.normalMatrix.getNormalMatrix(x.modelViewMatrix),P.onBeforeRender(M,I,D,N,x,tt),P.transparent===!0&&P.side===an&&P.forceSinglePass===!1?(P.side=Re,P.needsUpdate=!0,M.renderBufferDirect(D,I,N,P,x,tt),P.side=wn,P.needsUpdate=!0,M.renderBufferDirect(D,I,N,P,x,tt),P.side=an):M.renderBufferDirect(D,I,N,P,x,tt),x.onAfterRender(M,I,D,N,P,tt)}function es(x,I,D){I.isScene!==!0&&(I=Dt);let N=wt.get(x),P=d.state.lights,tt=d.state.shadowsArray,st=P.state.version,ft=At.getParameters(x,P.state,tt,I,D),mt=At.getProgramCacheKey(ft),vt=N.programs;N.environment=x.isMeshStandardMaterial?I.environment:null,N.fog=I.fog,N.envMap=(x.isMeshStandardMaterial?U:A).get(x.envMap||N.environment),N.envMapRotation=N.environment!==null&&x.envMap===null?I.environmentRotation:x.envMapRotation,vt===void 0&&(x.addEventListener("dispose",Bt),vt=new Map,N.programs=vt);let Mt=vt.get(mt);if(Mt!==void 0){if(N.currentProgram===Mt&&N.lightsStateVersion===st)return oc(x,ft),Mt}else ft.uniforms=At.getUniforms(x),x.onBeforeCompile(ft,M),Mt=At.acquireProgram(ft,mt),vt.set(mt,Mt),N.uniforms=ft.uniforms;let _t=N.uniforms;return(!x.isShaderMaterial&&!x.isRawShaderMaterial||x.clipping===!0)&&(_t.clippingPlanes=Q.uniform),oc(x,ft),N.needsLights=rh(x),N.lightsStateVersion=st,N.needsLights&&(_t.ambientLightColor.value=P.state.ambient,_t.lightProbe.value=P.state.probe,_t.directionalLights.value=P.state.directional,_t.directionalLightShadows.value=P.state.directionalShadow,_t.spotLights.value=P.state.spot,_t.spotLightShadows.value=P.state.spotShadow,_t.rectAreaLights.value=P.state.rectArea,_t.ltc_1.value=P.state.rectAreaLTC1,_t.ltc_2.value=P.state.rectAreaLTC2,_t.pointLights.value=P.state.point,_t.pointLightShadows.value=P.state.pointShadow,_t.hemisphereLights.value=P.state.hemi,_t.directionalShadowMap.value=P.state.directionalShadowMap,_t.directionalShadowMatrix.value=P.state.directionalShadowMatrix,_t.spotShadowMap.value=P.state.spotShadowMap,_t.spotLightMatrix.value=P.state.spotLightMatrix,_t.spotLightMap.value=P.state.spotLightMap,_t.pointShadowMap.value=P.state.pointShadowMap,_t.pointShadowMatrix.value=P.state.pointShadowMatrix),N.currentProgram=Mt,N.uniformsList=null,Mt}function ac(x){if(x.uniformsList===null){let I=x.currentProgram.getUniforms();x.uniformsList=Mi.seqWithValue(I.seq,x.uniforms)}return x.uniformsList}function oc(x,I){let D=wt.get(x);D.outputColorSpace=I.outputColorSpace,D.batching=I.batching,D.batchingColor=I.batchingColor,D.instancing=I.instancing,D.instancingColor=I.instancingColor,D.instancingMorph=I.instancingMorph,D.skinning=I.skinning,D.morphTargets=I.morphTargets,D.morphNormals=I.morphNormals,D.morphColors=I.morphColors,D.morphTargetsCount=I.morphTargetsCount,D.numClippingPlanes=I.numClippingPlanes,D.numIntersection=I.numClipIntersection,D.vertexAlphas=I.vertexAlphas,D.vertexTangents=I.vertexTangents,D.toneMapping=I.toneMapping}function ih(x,I,D,N,P){I.isScene!==!0&&(I=Dt),S.resetTextureUnits();let tt=I.fog,st=N.isMeshStandardMaterial?I.environment:null,ft=w===null?M.outputColorSpace:w.isXRRenderTarget===!0?w.texture.colorSpace:Un,mt=(N.isMeshStandardMaterial?U:A).get(N.envMap||st),vt=N.vertexColors===!0&&!!D.attributes.color&&D.attributes.color.itemSize===4,Mt=!!D.attributes.tangent&&(!!N.normalMap||N.anisotropy>0),_t=!!D.morphAttributes.position,Xt=!!D.morphAttributes.normal,Jt=!!D.morphAttributes.color,se=En;N.toneMapped&&(w===null||w.isXRRenderTarget===!0)&&(se=M.toneMapping);let Le=D.morphAttributes.position||D.morphAttributes.normal||D.morphAttributes.color,Vt=Le!==void 0?Le.length:0,xt=wt.get(N),de=d.state.lights;if(G===!0&&(J===!0||x!==Z)){let Fe=x===Z&&N.id===O;Q.setState(N,x,Fe)}let Gt=!1;N.version===xt.__version?(xt.needsLights&&xt.lightsStateVersion!==de.state.version||xt.outputColorSpace!==ft||P.isBatchedMesh&&xt.batching===!1||!P.isBatchedMesh&&xt.batching===!0||P.isBatchedMesh&&xt.batchingColor===!0&&P.colorTexture===null||P.isBatchedMesh&&xt.batchingColor===!1&&P.colorTexture!==null||P.isInstancedMesh&&xt.instancing===!1||!P.isInstancedMesh&&xt.instancing===!0||P.isSkinnedMesh&&xt.skinning===!1||!P.isSkinnedMesh&&xt.skinning===!0||P.isInstancedMesh&&xt.instancingColor===!0&&P.instanceColor===null||P.isInstancedMesh&&xt.instancingColor===!1&&P.instanceColor!==null||P.isInstancedMesh&&xt.instancingMorph===!0&&P.morphTexture===null||P.isInstancedMesh&&xt.instancingMorph===!1&&P.morphTexture!==null||xt.envMap!==mt||N.fog===!0&&xt.fog!==tt||xt.numClippingPlanes!==void 0&&(xt.numClippingPlanes!==Q.numPlanes||xt.numIntersection!==Q.numIntersection)||xt.vertexAlphas!==vt||xt.vertexTangents!==Mt||xt.morphTargets!==_t||xt.morphNormals!==Xt||xt.morphColors!==Jt||xt.toneMapping!==se||xt.morphTargetsCount!==Vt)&&(Gt=!0):(Gt=!0,xt.__version=N.version);let ke=xt.currentProgram;Gt===!0&&(ke=es(N,I,P));let ni=!1,Ue=!1,Er=!1,ae=ke.getUniforms(),pn=xt.uniforms;if(St.useProgram(ke.program)&&(ni=!0,Ue=!0,Er=!0),N.id!==O&&(O=N.id,Ue=!0),ni||Z!==x){Ft.reverseDepthBuffer?(pt.copy(x.projectionMatrix),tu(pt),eu(pt),ae.setValue(T,"projectionMatrix",pt)):ae.setValue(T,"projectionMatrix",x.projectionMatrix),ae.setValue(T,"viewMatrix",x.matrixWorldInverse);let Fe=ae.map.cameraPosition;Fe!==void 0&&Fe.setValue(T,Tt.setFromMatrixPosition(x.matrixWorld)),Ft.logarithmicDepthBuffer&&ae.setValue(T,"logDepthBufFC",2/(Math.log(x.far+1)/Math.LN2)),(N.isMeshPhongMaterial||N.isMeshToonMaterial||N.isMeshLambertMaterial||N.isMeshBasicMaterial||N.isMeshStandardMaterial||N.isShaderMaterial)&&ae.setValue(T,"isOrthographic",x.isOrthographicCamera===!0),Z!==x&&(Z=x,Ue=!0,Er=!0)}if(P.isSkinnedMesh){ae.setOptional(T,P,"bindMatrix"),ae.setOptional(T,P,"bindMatrixInverse");let Fe=P.skeleton;Fe&&(Fe.boneTexture===null&&Fe.computeBoneTexture(),ae.setValue(T,"boneTexture",Fe.boneTexture,S))}P.isBatchedMesh&&(ae.setOptional(T,P,"batchingTexture"),ae.setValue(T,"batchingTexture",P._matricesTexture,S),ae.setOptional(T,P,"batchingIdTexture"),ae.setValue(T,"batchingIdTexture",P._indirectTexture,S),ae.setOptional(T,P,"batchingColorTexture"),P._colorsTexture!==null&&ae.setValue(T,"batchingColorTexture",P._colorsTexture,S));let wr=D.morphAttributes;if((wr.position!==void 0||wr.normal!==void 0||wr.color!==void 0)&&Et.update(P,D,ke),(Ue||xt.receiveShadow!==P.receiveShadow)&&(xt.receiveShadow=P.receiveShadow,ae.setValue(T,"receiveShadow",P.receiveShadow)),N.isMeshGouraudMaterial&&N.envMap!==null&&(pn.envMap.value=mt,pn.flipEnvMap.value=mt.isCubeTexture&&mt.isRenderTargetTexture===!1?-1:1),N.isMeshStandardMaterial&&N.envMap===null&&I.environment!==null&&(pn.envMapIntensity.value=I.environmentIntensity),Ue&&(ae.setValue(T,"toneMappingExposure",M.toneMappingExposure),xt.needsLights&&sh(pn,Er),tt&&N.fog===!0&&nt.refreshFogUniforms(pn,tt),nt.refreshMaterialUniforms(pn,N,K,z,d.state.transmissionRenderTarget[x.id]),Mi.upload(T,ac(xt),pn,S)),N.isShaderMaterial&&N.uniformsNeedUpdate===!0&&(Mi.upload(T,ac(xt),pn,S),N.uniformsNeedUpdate=!1),N.isSpriteMaterial&&ae.setValue(T,"center",P.center),ae.setValue(T,"modelViewMatrix",P.modelViewMatrix),ae.setValue(T,"normalMatrix",P.normalMatrix),ae.setValue(T,"modelMatrix",P.matrixWorld),N.isShaderMaterial||N.isRawShaderMaterial){let Fe=N.uniformsGroups;for(let Tr=0,ah=Fe.length;Tr<ah;Tr++){let cc=Fe[Tr];R.update(cc,ke),R.bind(cc,ke)}}return ke}function sh(x,I){x.ambientLightColor.needsUpdate=I,x.lightProbe.needsUpdate=I,x.directionalLights.needsUpdate=I,x.directionalLightShadows.needsUpdate=I,x.pointLights.needsUpdate=I,x.pointLightShadows.needsUpdate=I,x.spotLights.needsUpdate=I,x.spotLightShadows.needsUpdate=I,x.rectAreaLights.needsUpdate=I,x.hemisphereLights.needsUpdate=I}function rh(x){return x.isMeshLambertMaterial||x.isMeshToonMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isShadowMaterial||x.isShaderMaterial&&x.lights===!0}this.getActiveCubeFace=function(){return B},this.getActiveMipmapLevel=function(){return C},this.getRenderTarget=function(){return w},this.setRenderTargetTextures=function(x,I,D){wt.get(x.texture).__webglTexture=I,wt.get(x.depthTexture).__webglTexture=D;let N=wt.get(x);N.__hasExternalTextures=!0,N.__autoAllocateDepthBuffer=D===void 0,N.__autoAllocateDepthBuffer||Lt.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),N.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(x,I){let D=wt.get(x);D.__webglFramebuffer=I,D.__useDefaultFramebuffer=I===void 0},this.setRenderTarget=function(x,I=0,D=0){w=x,B=I,C=D;let N=!0,P=null,tt=!1,st=!1;if(x){let mt=wt.get(x);if(mt.__useDefaultFramebuffer!==void 0)St.bindFramebuffer(T.FRAMEBUFFER,null),N=!1;else if(mt.__webglFramebuffer===void 0)S.setupRenderTarget(x);else if(mt.__hasExternalTextures)S.rebindTextures(x,wt.get(x.texture).__webglTexture,wt.get(x.depthTexture).__webglTexture);else if(x.depthBuffer){let _t=x.depthTexture;if(mt.__boundDepthTexture!==_t){if(_t!==null&&wt.has(_t)&&(x.width!==_t.image.width||x.height!==_t.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");S.setupDepthRenderbuffer(x)}}let vt=x.texture;(vt.isData3DTexture||vt.isDataArrayTexture||vt.isCompressedArrayTexture)&&(st=!0);let Mt=wt.get(x).__webglFramebuffer;x.isWebGLCubeRenderTarget?(Array.isArray(Mt[I])?P=Mt[I][D]:P=Mt[I],tt=!0):x.samples>0&&S.useMultisampledRTT(x)===!1?P=wt.get(x).__webglMultisampledFramebuffer:Array.isArray(Mt)?P=Mt[D]:P=Mt,g.copy(x.viewport),v.copy(x.scissor),k=x.scissorTest}else g.copy(ct).multiplyScalar(K).floor(),v.copy(gt).multiplyScalar(K).floor(),k=kt;if(St.bindFramebuffer(T.FRAMEBUFFER,P)&&N&&St.drawBuffers(x,P),St.viewport(g),St.scissor(v),St.setScissorTest(k),tt){let mt=wt.get(x.texture);T.framebufferTexture2D(T.FRAMEBUFFER,T.COLOR_ATTACHMENT0,T.TEXTURE_CUBE_MAP_POSITIVE_X+I,mt.__webglTexture,D)}else if(st){let mt=wt.get(x.texture),vt=I||0;T.framebufferTextureLayer(T.FRAMEBUFFER,T.COLOR_ATTACHMENT0,mt.__webglTexture,D||0,vt)}O=-1},this.readRenderTargetPixels=function(x,I,D,N,P,tt,st){if(!(x&&x.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ft=wt.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&st!==void 0&&(ft=ft[st]),ft){St.bindFramebuffer(T.FRAMEBUFFER,ft);try{let mt=x.texture,vt=mt.format,Mt=mt.type;if(!Ft.textureFormatReadable(vt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Ft.textureTypeReadable(Mt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}I>=0&&I<=x.width-N&&D>=0&&D<=x.height-P&&T.readPixels(I,D,N,P,Rt.convert(vt),Rt.convert(Mt),tt)}finally{let mt=w!==null?wt.get(w).__webglFramebuffer:null;St.bindFramebuffer(T.FRAMEBUFFER,mt)}}},this.readRenderTargetPixelsAsync=async function(x,I,D,N,P,tt,st){if(!(x&&x.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ft=wt.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&st!==void 0&&(ft=ft[st]),ft){let mt=x.texture,vt=mt.format,Mt=mt.type;if(!Ft.textureFormatReadable(vt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Ft.textureTypeReadable(Mt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(I>=0&&I<=x.width-N&&D>=0&&D<=x.height-P){St.bindFramebuffer(T.FRAMEBUFFER,ft);let _t=T.createBuffer();T.bindBuffer(T.PIXEL_PACK_BUFFER,_t),T.bufferData(T.PIXEL_PACK_BUFFER,tt.byteLength,T.STREAM_READ),T.readPixels(I,D,N,P,Rt.convert(vt),Rt.convert(Mt),0);let Xt=w!==null?wt.get(w).__webglFramebuffer:null;St.bindFramebuffer(T.FRAMEBUFFER,Xt);let Jt=T.fenceSync(T.SYNC_GPU_COMMANDS_COMPLETE,0);return T.flush(),await Qh(T,Jt,4),T.bindBuffer(T.PIXEL_PACK_BUFFER,_t),T.getBufferSubData(T.PIXEL_PACK_BUFFER,0,tt),T.deleteBuffer(_t),T.deleteSync(Jt),tt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(x,I=null,D=0){x.isTexture!==!0&&(Is("WebGLRenderer: copyFramebufferToTexture function signature has changed."),I=arguments[0]||null,x=arguments[1]);let N=Math.pow(2,-D),P=Math.floor(x.image.width*N),tt=Math.floor(x.image.height*N),st=I!==null?I.x:0,ft=I!==null?I.y:0;S.setTexture2D(x,0),T.copyTexSubImage2D(T.TEXTURE_2D,D,0,0,st,ft,P,tt),St.unbindTexture()},this.copyTextureToTexture=function(x,I,D=null,N=null,P=0){x.isTexture!==!0&&(Is("WebGLRenderer: copyTextureToTexture function signature has changed."),N=arguments[0]||null,x=arguments[1],I=arguments[2],P=arguments[3]||0,D=null);let tt,st,ft,mt,vt,Mt;D!==null?(tt=D.max.x-D.min.x,st=D.max.y-D.min.y,ft=D.min.x,mt=D.min.y):(tt=x.image.width,st=x.image.height,ft=0,mt=0),N!==null?(vt=N.x,Mt=N.y):(vt=0,Mt=0);let _t=Rt.convert(I.format),Xt=Rt.convert(I.type);S.setTexture2D(I,0),T.pixelStorei(T.UNPACK_FLIP_Y_WEBGL,I.flipY),T.pixelStorei(T.UNPACK_PREMULTIPLY_ALPHA_WEBGL,I.premultiplyAlpha),T.pixelStorei(T.UNPACK_ALIGNMENT,I.unpackAlignment);let Jt=T.getParameter(T.UNPACK_ROW_LENGTH),se=T.getParameter(T.UNPACK_IMAGE_HEIGHT),Le=T.getParameter(T.UNPACK_SKIP_PIXELS),Vt=T.getParameter(T.UNPACK_SKIP_ROWS),xt=T.getParameter(T.UNPACK_SKIP_IMAGES),de=x.isCompressedTexture?x.mipmaps[P]:x.image;T.pixelStorei(T.UNPACK_ROW_LENGTH,de.width),T.pixelStorei(T.UNPACK_IMAGE_HEIGHT,de.height),T.pixelStorei(T.UNPACK_SKIP_PIXELS,ft),T.pixelStorei(T.UNPACK_SKIP_ROWS,mt),x.isDataTexture?T.texSubImage2D(T.TEXTURE_2D,P,vt,Mt,tt,st,_t,Xt,de.data):x.isCompressedTexture?T.compressedTexSubImage2D(T.TEXTURE_2D,P,vt,Mt,de.width,de.height,_t,de.data):T.texSubImage2D(T.TEXTURE_2D,P,vt,Mt,tt,st,_t,Xt,de),T.pixelStorei(T.UNPACK_ROW_LENGTH,Jt),T.pixelStorei(T.UNPACK_IMAGE_HEIGHT,se),T.pixelStorei(T.UNPACK_SKIP_PIXELS,Le),T.pixelStorei(T.UNPACK_SKIP_ROWS,Vt),T.pixelStorei(T.UNPACK_SKIP_IMAGES,xt),P===0&&I.generateMipmaps&&T.generateMipmap(T.TEXTURE_2D),St.unbindTexture()},this.copyTextureToTexture3D=function(x,I,D=null,N=null,P=0){x.isTexture!==!0&&(Is("WebGLRenderer: copyTextureToTexture3D function signature has changed."),D=arguments[0]||null,N=arguments[1]||null,x=arguments[2],I=arguments[3],P=arguments[4]||0);let tt,st,ft,mt,vt,Mt,_t,Xt,Jt,se=x.isCompressedTexture?x.mipmaps[P]:x.image;D!==null?(tt=D.max.x-D.min.x,st=D.max.y-D.min.y,ft=D.max.z-D.min.z,mt=D.min.x,vt=D.min.y,Mt=D.min.z):(tt=se.width,st=se.height,ft=se.depth,mt=0,vt=0,Mt=0),N!==null?(_t=N.x,Xt=N.y,Jt=N.z):(_t=0,Xt=0,Jt=0);let Le=Rt.convert(I.format),Vt=Rt.convert(I.type),xt;if(I.isData3DTexture)S.setTexture3D(I,0),xt=T.TEXTURE_3D;else if(I.isDataArrayTexture||I.isCompressedArrayTexture)S.setTexture2DArray(I,0),xt=T.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}T.pixelStorei(T.UNPACK_FLIP_Y_WEBGL,I.flipY),T.pixelStorei(T.UNPACK_PREMULTIPLY_ALPHA_WEBGL,I.premultiplyAlpha),T.pixelStorei(T.UNPACK_ALIGNMENT,I.unpackAlignment);let de=T.getParameter(T.UNPACK_ROW_LENGTH),Gt=T.getParameter(T.UNPACK_IMAGE_HEIGHT),ke=T.getParameter(T.UNPACK_SKIP_PIXELS),ni=T.getParameter(T.UNPACK_SKIP_ROWS),Ue=T.getParameter(T.UNPACK_SKIP_IMAGES);T.pixelStorei(T.UNPACK_ROW_LENGTH,se.width),T.pixelStorei(T.UNPACK_IMAGE_HEIGHT,se.height),T.pixelStorei(T.UNPACK_SKIP_PIXELS,mt),T.pixelStorei(T.UNPACK_SKIP_ROWS,vt),T.pixelStorei(T.UNPACK_SKIP_IMAGES,Mt),x.isDataTexture||x.isData3DTexture?T.texSubImage3D(xt,P,_t,Xt,Jt,tt,st,ft,Le,Vt,se.data):I.isCompressedArrayTexture?T.compressedTexSubImage3D(xt,P,_t,Xt,Jt,tt,st,ft,Le,se.data):T.texSubImage3D(xt,P,_t,Xt,Jt,tt,st,ft,Le,Vt,se),T.pixelStorei(T.UNPACK_ROW_LENGTH,de),T.pixelStorei(T.UNPACK_IMAGE_HEIGHT,Gt),T.pixelStorei(T.UNPACK_SKIP_PIXELS,ke),T.pixelStorei(T.UNPACK_SKIP_ROWS,ni),T.pixelStorei(T.UNPACK_SKIP_IMAGES,Ue),P===0&&I.generateMipmaps&&T.generateMipmap(xt),St.unbindTexture()},this.initRenderTarget=function(x){wt.get(x).__webglFramebuffer===void 0&&S.setupRenderTarget(x)},this.initTexture=function(x){x.isCubeTexture?S.setTextureCube(x,0):x.isData3DTexture?S.setTexture3D(x,0):x.isDataArrayTexture||x.isCompressedArrayTexture?S.setTexture2DArray(x,0):S.setTexture2D(x,0),St.unbindTexture()},this.resetState=function(){B=0,C=0,w=null,St.reset(),Zt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return on}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let e=this.getContext();e.drawingBufferColorSpace=t===Lo?"display-p3":"srgb",e.unpackColorSpace=Wt.workingColorSpace===nr?"display-p3":"srgb"}},Gi=class i{constructor(t,e=25e-5){this.isFogExp2=!0,this.name="",this.color=new Pt(t),this.density=e}clone(){return new i(this.color,this.density)}toJSON(){return{type:"FogExp2",name:this.name,color:this.color.getHex(),density:this.density}}},Ys=class extends ve{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new $e,this.environmentIntensity=1,this.environmentRotation=new $e,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(t,e){return super.copy(t,e),t.background!==null&&(this.background=t.background.clone()),t.environment!==null&&(this.environment=t.environment.clone()),t.fog!==null&&(this.fog=t.fog.clone()),this.backgroundBlurriness=t.backgroundBlurriness,this.backgroundIntensity=t.backgroundIntensity,this.backgroundRotation.copy(t.backgroundRotation),this.environmentIntensity=t.environmentIntensity,this.environmentRotation.copy(t.environmentRotation),t.overrideMaterial!==null&&(this.overrideMaterial=t.overrideMaterial.clone()),this.matrixAutoUpdate=t.matrixAutoUpdate,this}toJSON(t){let e=super.toJSON(t);return this.fog!==null&&(e.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(e.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(e.object.backgroundIntensity=this.backgroundIntensity),e.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(e.object.environmentIntensity=this.environmentIntensity),e.object.environmentRotation=this.environmentRotation.toArray(),e}},uo=class extends Ce{constructor(t=null,e=1,n=1,s,r,a,o,c,l=Te,h=Te,p,f){super(null,a,o,c,l,h,s,r,p,f),this.isDataTexture=!0,this.image={data:t,width:e,height:n},this.generateMipmaps=!1,this.flipY=!1,this.unpackAlignment=1}},$s=class extends Be{constructor(t,e,n,s=1){super(t,e,n),this.isInstancedBufferAttribute=!0,this.meshPerAttribute=s}copy(t){return super.copy(t),this.meshPerAttribute=t.meshPerAttribute,this}toJSON(){let t=super.toJSON();return t.meshPerAttribute=this.meshPerAttribute,t.isInstancedBufferAttribute=!0,t}},Ai=new te,al=new te,Ss=[],ol=new un,Km=new te,Fi=new fe,Oi=new Zn,Qn=class extends fe{constructor(t,e,n){super(t,e),this.isInstancedMesh=!0,this.instanceMatrix=new $s(new Float32Array(n*16),16),this.instanceColor=null,this.morphTexture=null,this.count=n,this.boundingBox=null,this.boundingSphere=null;for(let s=0;s<n;s++)this.setMatrixAt(s,Km)}computeBoundingBox(){let t=this.geometry,e=this.count;this.boundingBox===null&&(this.boundingBox=new un),t.boundingBox===null&&t.computeBoundingBox(),this.boundingBox.makeEmpty();for(let n=0;n<e;n++)this.getMatrixAt(n,Ai),ol.copy(t.boundingBox).applyMatrix4(Ai),this.boundingBox.union(ol)}computeBoundingSphere(){let t=this.geometry,e=this.count;this.boundingSphere===null&&(this.boundingSphere=new Zn),t.boundingSphere===null&&t.computeBoundingSphere(),this.boundingSphere.makeEmpty();for(let n=0;n<e;n++)this.getMatrixAt(n,Ai),Oi.copy(t.boundingSphere).applyMatrix4(Ai),this.boundingSphere.union(Oi)}copy(t,e){return super.copy(t,e),this.instanceMatrix.copy(t.instanceMatrix),t.morphTexture!==null&&(this.morphTexture=t.morphTexture.clone()),t.instanceColor!==null&&(this.instanceColor=t.instanceColor.clone()),this.count=t.count,t.boundingBox!==null&&(this.boundingBox=t.boundingBox.clone()),t.boundingSphere!==null&&(this.boundingSphere=t.boundingSphere.clone()),this}getColorAt(t,e){e.fromArray(this.instanceColor.array,t*3)}getMatrixAt(t,e){e.fromArray(this.instanceMatrix.array,t*16)}getMorphAt(t,e){let n=e.morphTargetInfluences,s=this.morphTexture.source.data.data,r=n.length+1,a=t*r+1;for(let o=0;o<n.length;o++)n[o]=s[a+o]}raycast(t,e){let n=this.matrixWorld,s=this.count;if(Fi.geometry=this.geometry,Fi.material=this.material,Fi.material!==void 0&&(this.boundingSphere===null&&this.computeBoundingSphere(),Oi.copy(this.boundingSphere),Oi.applyMatrix4(n),t.ray.intersectsSphere(Oi)!==!1))for(let r=0;r<s;r++){this.getMatrixAt(r,Ai),al.multiplyMatrices(n,Ai),Fi.matrixWorld=al,Fi.raycast(t,Ss);for(let a=0,o=Ss.length;a<o;a++){let c=Ss[a];c.instanceId=r,c.object=this,e.push(c)}Ss.length=0}}setColorAt(t,e){this.instanceColor===null&&(this.instanceColor=new $s(new Float32Array(this.instanceMatrix.count*3).fill(1),3)),e.toArray(this.instanceColor.array,t*3)}setMatrixAt(t,e){e.toArray(this.instanceMatrix.array,t*16)}setMorphAt(t,e){let n=e.morphTargetInfluences,s=n.length+1;this.morphTexture===null&&(this.morphTexture=new uo(new Float32Array(s*this.count),s,this.count,Ro,Ye));let r=this.morphTexture.source.data.data,a=0;for(let l=0;l<n.length;l++)a+=n[l];let o=this.geometry.morphTargetsRelative?1:1-a,c=s*t;r[c]=o,r.set(n,c+1)}updateMorphTargets(){}dispose(){return this.dispatchEvent({type:"dispose"}),this.morphTexture!==null&&(this.morphTexture.dispose(),this.morphTexture=null),this}},Zs=class extends Ce{constructor(t,e,n,s,r,a,o,c,l){super(t,e,n,s,r,a,o,c,l),this.isCanvasTexture=!0,this.needsUpdate=!0}},Ln=class extends Kn{constructor(t){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new Pt(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Pt(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=Sl,this.normalScale=new jt(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new $e,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.defines={STANDARD:""},this.color.copy(t.color),this.roughness=t.roughness,this.metalness=t.metalness,this.map=t.map,this.lightMap=t.lightMap,this.lightMapIntensity=t.lightMapIntensity,this.aoMap=t.aoMap,this.aoMapIntensity=t.aoMapIntensity,this.emissive.copy(t.emissive),this.emissiveMap=t.emissiveMap,this.emissiveIntensity=t.emissiveIntensity,this.bumpMap=t.bumpMap,this.bumpScale=t.bumpScale,this.normalMap=t.normalMap,this.normalMapType=t.normalMapType,this.normalScale.copy(t.normalScale),this.displacementMap=t.displacementMap,this.displacementScale=t.displacementScale,this.displacementBias=t.displacementBias,this.roughnessMap=t.roughnessMap,this.metalnessMap=t.metalnessMap,this.alphaMap=t.alphaMap,this.envMap=t.envMap,this.envMapRotation.copy(t.envMapRotation),this.envMapIntensity=t.envMapIntensity,this.wireframe=t.wireframe,this.wireframeLinewidth=t.wireframeLinewidth,this.wireframeLinecap=t.wireframeLinecap,this.wireframeLinejoin=t.wireframeLinejoin,this.flatShading=t.flatShading,this.fog=t.fog,this}};Ci=class{constructor(t,e,n,s){this.parameterPositions=t,this._cachedIndex=0,this.resultBuffer=s!==void 0?s:new e.constructor(n),this.sampleValues=e,this.valueSize=n,this.settings=null,this.DefaultSettings_={}}evaluate(t){let e=this.parameterPositions,n=this._cachedIndex,s=e[n],r=e[n-1];n:{t:{let a;e:{i:if(!(t<s)){for(let o=n+2;;){if(s===void 0){if(t<r)break i;return n=e.length,this._cachedIndex=n,this.copySampleValue_(n-1)}if(n===o)break;if(r=s,s=e[++n],t<s)break t}a=e.length;break e}if(!(t>=r)){let o=e[1];t<o&&(n=2,r=o);for(let c=n-2;;){if(r===void 0)return this._cachedIndex=0,this.copySampleValue_(0);if(n===c)break;if(s=r,r=e[--n-1],t>=r)break t}a=n,n=0;break e}break n}for(;n<a;){let o=n+a>>>1;t<e[o]?a=o:n=o+1}if(s=e[n],r=e[n-1],r===void 0)return this._cachedIndex=0,this.copySampleValue_(0);if(s===void 0)return n=e.length,this._cachedIndex=n,this.copySampleValue_(n-1)}this._cachedIndex=n,this.intervalChanged_(n,r,s)}return this.interpolate_(n,r,t,s)}getSettings_(){return this.settings||this.DefaultSettings_}copySampleValue_(t){let e=this.resultBuffer,n=this.sampleValues,s=this.valueSize,r=t*s;for(let a=0;a!==s;++a)e[a]=n[r+a];return e}interpolate_(){throw new Error("call to abstract method")}intervalChanged_(){}},fo=class extends Ci{constructor(t,e,n,s){super(t,e,n,s),this._weightPrev=-0,this._offsetPrev=-0,this._weightNext=-0,this._offsetNext=-0,this.DefaultSettings_={endingStart:pc,endingEnd:pc}}intervalChanged_(t,e,n){let s=this.parameterPositions,r=t-2,a=t+1,o=s[r],c=s[a];if(o===void 0)switch(this.getSettings_().endingStart){case mc:r=t,o=2*e-n;break;case gc:r=s.length-2,o=e+s[r]-s[r+1];break;default:r=t,o=n}if(c===void 0)switch(this.getSettings_().endingEnd){case mc:a=t,c=2*n-e;break;case gc:a=1,c=n+s[1]-s[0];break;default:a=t-1,c=e}let l=(n-e)*.5,h=this.valueSize;this._weightPrev=l/(e-o),this._weightNext=l/(c-n),this._offsetPrev=r*h,this._offsetNext=a*h}interpolate_(t,e,n,s){let r=this.resultBuffer,a=this.sampleValues,o=this.valueSize,c=t*o,l=c-o,h=this._offsetPrev,p=this._offsetNext,f=this._weightPrev,m=this._weightNext,_=(n-e)/(s-e),y=_*_,d=y*_,u=-f*d+2*f*y-f*_,b=(1+f)*d+(-1.5-2*f)*y+(-.5+f)*_+1,M=(-1-m)*d+(1.5+m)*y+.5*_,E=m*d-m*y;for(let B=0;B!==o;++B)r[B]=u*a[h+B]+b*a[l+B]+M*a[c+B]+E*a[p+B];return r}},po=class extends Ci{constructor(t,e,n,s){super(t,e,n,s)}interpolate_(t,e,n,s){let r=this.resultBuffer,a=this.sampleValues,o=this.valueSize,c=t*o,l=c-o,h=(n-e)/(s-e),p=1-h;for(let f=0;f!==o;++f)r[f]=a[l+f]*p+a[c+f]*h;return r}},mo=class extends Ci{constructor(t,e,n,s){super(t,e,n,s)}interpolate_(t){return this.copySampleValue_(t-1)}},We=class{constructor(t,e,n,s){if(t===void 0)throw new Error("THREE.KeyframeTrack: track name is undefined");if(e===void 0||e.length===0)throw new Error("THREE.KeyframeTrack: no keyframes in track named "+t);this.name=t,this.times=bs(e,this.TimeBufferType),this.values=bs(n,this.ValueBufferType),this.setInterpolation(s||this.DefaultInterpolation)}static toJSON(t){let e=t.constructor,n;if(e.toJSON!==this.toJSON)n=e.toJSON(t);else{n={name:t.name,times:bs(t.times,Array),values:bs(t.values,Array)};let s=t.getInterpolation();s!==t.DefaultInterpolation&&(n.interpolation=s)}return n.type=t.ValueTypeName,n}InterpolantFactoryMethodDiscrete(t){return new mo(this.times,this.values,this.getValueSize(),t)}InterpolantFactoryMethodLinear(t){return new po(this.times,this.values,this.getValueSize(),t)}InterpolantFactoryMethodSmooth(t){return new fo(this.times,this.values,this.getValueSize(),t)}setInterpolation(t){let e;switch(t){case Ps:e=this.InterpolantFactoryMethodDiscrete;break;case Wa:e=this.InterpolantFactoryMethodLinear;break;case Cr:e=this.InterpolantFactoryMethodSmooth;break}if(e===void 0){let n="unsupported interpolation for "+this.ValueTypeName+" keyframe track named "+this.name;if(this.createInterpolant===void 0)if(t!==this.DefaultInterpolation)this.setInterpolation(this.DefaultInterpolation);else throw new Error(n);return console.warn("THREE.KeyframeTrack:",n),this}return this.createInterpolant=e,this}getInterpolation(){switch(this.createInterpolant){case this.InterpolantFactoryMethodDiscrete:return Ps;case this.InterpolantFactoryMethodLinear:return Wa;case this.InterpolantFactoryMethodSmooth:return Cr}}getValueSize(){return this.values.length/this.times.length}shift(t){if(t!==0){let e=this.times;for(let n=0,s=e.length;n!==s;++n)e[n]+=t}return this}scale(t){if(t!==1){let e=this.times;for(let n=0,s=e.length;n!==s;++n)e[n]*=t}return this}trim(t,e){let n=this.times,s=n.length,r=0,a=s-1;for(;r!==s&&n[r]<t;)++r;for(;a!==-1&&n[a]>e;)--a;if(++a,r!==0||a!==s){r>=a&&(a=Math.max(a,1),r=a-1);let o=this.getValueSize();this.times=n.slice(r,a),this.values=this.values.slice(r*o,a*o)}return this}validate(){let t=!0,e=this.getValueSize();e-Math.floor(e)!==0&&(console.error("THREE.KeyframeTrack: Invalid value size in track.",this),t=!1);let n=this.times,s=this.values,r=n.length;r===0&&(console.error("THREE.KeyframeTrack: Track is empty.",this),t=!1);let a=null;for(let o=0;o!==r;o++){let c=n[o];if(typeof c=="number"&&isNaN(c)){console.error("THREE.KeyframeTrack: Time is not a valid number.",this,o,c),t=!1;break}if(a!==null&&a>c){console.error("THREE.KeyframeTrack: Out of order keys.",this,o,c,a),t=!1;break}a=c}if(s!==void 0&&Jm(s))for(let o=0,c=s.length;o!==c;++o){let l=s[o];if(isNaN(l)){console.error("THREE.KeyframeTrack: Value is not a valid number.",this,o,l),t=!1;break}}return t}optimize(){let t=this.times.slice(),e=this.values.slice(),n=this.getValueSize(),s=this.getInterpolation()===Cr,r=t.length-1,a=1;for(let o=1;o<r;++o){let c=!1,l=t[o],h=t[o+1];if(l!==h&&(o!==1||l!==t[0]))if(s)c=!0;else{let p=o*n,f=p-n,m=p+n;for(let _=0;_!==n;++_){let y=e[p+_];if(y!==e[f+_]||y!==e[m+_]){c=!0;break}}}if(c){if(o!==a){t[a]=t[o];let p=o*n,f=a*n;for(let m=0;m!==n;++m)e[f+m]=e[p+m]}++a}}if(r>0){t[a]=t[r];for(let o=r*n,c=a*n,l=0;l!==n;++l)e[c+l]=e[o+l];++a}return a!==t.length?(this.times=t.slice(0,a),this.values=e.slice(0,a*n)):(this.times=t,this.values=e),this}clone(){let t=this.times.slice(),e=this.values.slice(),n=this.constructor,s=new n(this.name,t,e);return s.createInterpolant=this.createInterpolant,s}};We.prototype.TimeBufferType=Float32Array;We.prototype.ValueBufferType=Float32Array;We.prototype.DefaultInterpolation=Wa;ti=class extends We{constructor(t,e,n){super(t,e,n)}};ti.prototype.ValueTypeName="bool";ti.prototype.ValueBufferType=Array;ti.prototype.DefaultInterpolation=Ps;ti.prototype.InterpolantFactoryMethodLinear=void 0;ti.prototype.InterpolantFactoryMethodSmooth=void 0;go=class extends We{};go.prototype.ValueTypeName="color";Ao=class extends We{};Ao.prototype.ValueTypeName="number";_o=class extends Ci{constructor(t,e,n,s){super(t,e,n,s)}interpolate_(t,e,n,s){let r=this.resultBuffer,a=this.sampleValues,o=this.valueSize,c=(n-e)/(s-e),l=t*o;for(let h=l+o;l!==h;l+=4)Cn.slerpFlat(r,0,a,l-o,a,l,c);return r}},Ks=class extends We{InterpolantFactoryMethodLinear(t){return new _o(this.times,this.values,this.getValueSize(),t)}};Ks.prototype.ValueTypeName="quaternion";Ks.prototype.InterpolantFactoryMethodSmooth=void 0;ei=class extends We{constructor(t,e,n){super(t,e,n)}};ei.prototype.ValueTypeName="string";ei.prototype.ValueBufferType=Array;ei.prototype.DefaultInterpolation=Ps;ei.prototype.InterpolantFactoryMethodLinear=void 0;ei.prototype.InterpolantFactoryMethodSmooth=void 0;xo=class extends We{};xo.prototype.ValueTypeName="vector";vo=class{constructor(t,e,n){let s=this,r=!1,a=0,o=0,c,l=[];this.onStart=void 0,this.onLoad=t,this.onProgress=e,this.onError=n,this.itemStart=function(h){o++,r===!1&&s.onStart!==void 0&&s.onStart(h,a,o),r=!0},this.itemEnd=function(h){a++,s.onProgress!==void 0&&s.onProgress(h,a,o),a===o&&(r=!1,s.onLoad!==void 0&&s.onLoad())},this.itemError=function(h){s.onError!==void 0&&s.onError(h)},this.resolveURL=function(h){return c?c(h):h},this.setURLModifier=function(h){return c=h,this},this.addHandler=function(h,p){return l.push(h,p),this},this.removeHandler=function(h){let p=l.indexOf(h);return p!==-1&&l.splice(p,2),this},this.getHandler=function(h){for(let p=0,f=l.length;p<f;p+=2){let m=l[p],_=l[p+1];if(m.global&&(m.lastIndex=0),m.test(h))return _}return null}}},Qm=new vo,yo=class{constructor(t){this.manager=t!==void 0?t:Qm,this.crossOrigin="anonymous",this.withCredentials=!1,this.path="",this.resourcePath="",this.requestHeader={}}load(){}loadAsync(t,e){let n=this;return new Promise(function(s,r){n.load(t,s,e,r)})}parse(){}setCrossOrigin(t){return this.crossOrigin=t,this}setWithCredentials(t){return this.withCredentials=t,this}setPath(t){return this.path=t,this}setResourcePath(t){return this.resourcePath=t,this}setRequestHeader(t){return this.requestHeader=t,this}};yo.DEFAULT_MATERIAL_NAME="__DEFAULT";Wi=class extends ve{constructor(t,e=1){super(),this.isLight=!0,this.type="Light",this.color=new Pt(t),this.intensity=e}dispose(){}copy(t,e){return super.copy(t,e),this.color.copy(t.color),this.intensity=t.intensity,this}toJSON(t){let e=super.toJSON(t);return e.object.color=this.color.getHex(),e.object.intensity=this.intensity,this.groundColor!==void 0&&(e.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(e.object.distance=this.distance),this.angle!==void 0&&(e.object.angle=this.angle),this.decay!==void 0&&(e.object.decay=this.decay),this.penumbra!==void 0&&(e.object.penumbra=this.penumbra),this.shadow!==void 0&&(e.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(e.object.target=this.target.uuid),e}},Js=class extends Wi{constructor(t,e,n){super(t,n),this.isHemisphereLight=!0,this.type="HemisphereLight",this.position.copy(ve.DEFAULT_UP),this.updateMatrix(),this.groundColor=new Pt(e)}copy(t,e){return super.copy(t,e),this.groundColor.copy(t.groundColor),this}},ra=new te,cl=new L,ll=new L,Mo=class{constructor(t){this.camera=t,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new jt(512,512),this.map=null,this.mapPass=null,this.matrix=new te,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new Vi,this._frameExtents=new jt(1,1),this._viewportCount=1,this._viewports=[new $t(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(t){let e=this.camera,n=this.matrix;cl.setFromMatrixPosition(t.matrixWorld),e.position.copy(cl),ll.setFromMatrixPosition(t.target.matrixWorld),e.lookAt(ll),e.updateMatrixWorld(),ra.multiplyMatrices(e.projectionMatrix,e.matrixWorldInverse),this._frustum.setFromProjectionMatrix(ra),n.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),n.multiply(ra)}getViewport(t){return this._viewports[t]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(t){return this.camera=t.camera.clone(),this.intensity=t.intensity,this.bias=t.bias,this.radius=t.radius,this.mapSize.copy(t.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){let t={};return this.intensity!==1&&(t.intensity=this.intensity),this.bias!==0&&(t.bias=this.bias),this.normalBias!==0&&(t.normalBias=this.normalBias),this.radius!==1&&(t.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(t.mapSize=this.mapSize.toArray()),t.camera=this.camera.toJSON(!1).object,delete t.camera.matrix,t}},hl=new te,ki=new L,aa=new L,So=class extends Mo{constructor(){super(new ge(90,1,.5,500)),this.isPointLightShadow=!0,this._frameExtents=new jt(4,2),this._viewportCount=6,this._viewports=[new $t(2,1,1,1),new $t(0,1,1,1),new $t(3,1,1,1),new $t(1,1,1,1),new $t(3,0,1,1),new $t(1,0,1,1)],this._cubeDirections=[new L(1,0,0),new L(-1,0,0),new L(0,0,1),new L(0,0,-1),new L(0,1,0),new L(0,-1,0)],this._cubeUps=[new L(0,1,0),new L(0,1,0),new L(0,1,0),new L(0,1,0),new L(0,0,1),new L(0,0,-1)]}updateMatrices(t,e=0){let n=this.camera,s=this.matrix,r=t.distance||n.far;r!==n.far&&(n.far=r,n.updateProjectionMatrix()),ki.setFromMatrixPosition(t.matrixWorld),n.position.copy(ki),aa.copy(n.position),aa.add(this._cubeDirections[e]),n.up.copy(this._cubeUps[e]),n.lookAt(aa),n.updateMatrixWorld(),s.makeTranslation(-ki.x,-ki.y,-ki.z),hl.multiplyMatrices(n.projectionMatrix,n.matrixWorldInverse),this._frustum.setFromProjectionMatrix(hl)}},Qs=class extends Wi{constructor(t,e,n=0,s=2){super(t,e),this.isPointLight=!0,this.type="PointLight",this.distance=n,this.decay=s,this.shadow=new So}get power(){return this.intensity*4*Math.PI}set power(t){this.intensity=t/(4*Math.PI)}dispose(){this.shadow.dispose()}copy(t,e){return super.copy(t,e),this.distance=t.distance,this.decay=t.decay,this.shadow=t.shadow.clone(),this}},tr=class extends Wi{constructor(t,e){super(t,e),this.isAmbientLight=!0,this.type="AmbientLight"}},Do="\\[\\]\\.:\\/",tg=new RegExp("["+Do+"]","g"),No="[^"+Do+"]",eg="[^"+Do.replace("\\.","")+"]",ng=/((?:WC+[\/:])*)/.source.replace("WC",No),ig=/(WCOD+)?/.source.replace("WCOD",eg),sg=/(?:\.(WC+)(?:\[(.+)\])?)?/.source.replace("WC",No),rg=/\.(WC+)(?:\[(.+)\])?/.source.replace("WC",No),ag=new RegExp("^"+ng+ig+sg+rg+"$"),og=["material","materials","bones","map"],bo=class{constructor(t,e,n){let s=n||ne.parseTrackName(e);this._targetGroup=t,this._bindings=t.subscribe_(e,s)}getValue(t,e){this.bind();let n=this._targetGroup.nCachedObjects_,s=this._bindings[n];s!==void 0&&s.getValue(t,e)}setValue(t,e){let n=this._bindings;for(let s=this._targetGroup.nCachedObjects_,r=n.length;s!==r;++s)n[s].setValue(t,e)}bind(){let t=this._bindings;for(let e=this._targetGroup.nCachedObjects_,n=t.length;e!==n;++e)t[e].bind()}unbind(){let t=this._bindings;for(let e=this._targetGroup.nCachedObjects_,n=t.length;e!==n;++e)t[e].unbind()}},ne=class i{constructor(t,e,n){this.path=e,this.parsedPath=n||i.parseTrackName(e),this.node=i.findNode(t,this.parsedPath.nodeName),this.rootNode=t,this.getValue=this._getValue_unbound,this.setValue=this._setValue_unbound}static create(t,e,n){return t&&t.isAnimationObjectGroup?new i.Composite(t,e,n):new i(t,e,n)}static sanitizeNodeName(t){return t.replace(/\s/g,"_").replace(tg,"")}static parseTrackName(t){let e=ag.exec(t);if(e===null)throw new Error("PropertyBinding: Cannot parse trackName: "+t);let n={nodeName:e[2],objectName:e[3],objectIndex:e[4],propertyName:e[5],propertyIndex:e[6]},s=n.nodeName&&n.nodeName.lastIndexOf(".");if(s!==void 0&&s!==-1){let r=n.nodeName.substring(s+1);og.indexOf(r)!==-1&&(n.nodeName=n.nodeName.substring(0,s),n.objectName=r)}if(n.propertyName===null||n.propertyName.length===0)throw new Error("PropertyBinding: can not parse propertyName from trackName: "+t);return n}static findNode(t,e){if(e===void 0||e===""||e==="."||e===-1||e===t.name||e===t.uuid)return t;if(t.skeleton){let n=t.skeleton.getBoneByName(e);if(n!==void 0)return n}if(t.children){let n=function(r){for(let a=0;a<r.length;a++){let o=r[a];if(o.name===e||o.uuid===e)return o;let c=n(o.children);if(c)return c}return null},s=n(t.children);if(s)return s}return null}_getValue_unavailable(){}_setValue_unavailable(){}_getValue_direct(t,e){t[e]=this.targetObject[this.propertyName]}_getValue_array(t,e){let n=this.resolvedProperty;for(let s=0,r=n.length;s!==r;++s)t[e++]=n[s]}_getValue_arrayElement(t,e){t[e]=this.resolvedProperty[this.propertyIndex]}_getValue_toArray(t,e){this.resolvedProperty.toArray(t,e)}_setValue_direct(t,e){this.targetObject[this.propertyName]=t[e]}_setValue_direct_setNeedsUpdate(t,e){this.targetObject[this.propertyName]=t[e],this.targetObject.needsUpdate=!0}_setValue_direct_setMatrixWorldNeedsUpdate(t,e){this.targetObject[this.propertyName]=t[e],this.targetObject.matrixWorldNeedsUpdate=!0}_setValue_array(t,e){let n=this.resolvedProperty;for(let s=0,r=n.length;s!==r;++s)n[s]=t[e++]}_setValue_array_setNeedsUpdate(t,e){let n=this.resolvedProperty;for(let s=0,r=n.length;s!==r;++s)n[s]=t[e++];this.targetObject.needsUpdate=!0}_setValue_array_setMatrixWorldNeedsUpdate(t,e){let n=this.resolvedProperty;for(let s=0,r=n.length;s!==r;++s)n[s]=t[e++];this.targetObject.matrixWorldNeedsUpdate=!0}_setValue_arrayElement(t,e){this.resolvedProperty[this.propertyIndex]=t[e]}_setValue_arrayElement_setNeedsUpdate(t,e){this.resolvedProperty[this.propertyIndex]=t[e],this.targetObject.needsUpdate=!0}_setValue_arrayElement_setMatrixWorldNeedsUpdate(t,e){this.resolvedProperty[this.propertyIndex]=t[e],this.targetObject.matrixWorldNeedsUpdate=!0}_setValue_fromArray(t,e){this.resolvedProperty.fromArray(t,e)}_setValue_fromArray_setNeedsUpdate(t,e){this.resolvedProperty.fromArray(t,e),this.targetObject.needsUpdate=!0}_setValue_fromArray_setMatrixWorldNeedsUpdate(t,e){this.resolvedProperty.fromArray(t,e),this.targetObject.matrixWorldNeedsUpdate=!0}_getValue_unbound(t,e){this.bind(),this.getValue(t,e)}_setValue_unbound(t,e){this.bind(),this.setValue(t,e)}bind(){let t=this.node,e=this.parsedPath,n=e.objectName,s=e.propertyName,r=e.propertyIndex;if(t||(t=i.findNode(this.rootNode,e.nodeName),this.node=t),this.getValue=this._getValue_unavailable,this.setValue=this._setValue_unavailable,!t){console.warn("THREE.PropertyBinding: No target node found for track: "+this.path+".");return}if(n){let l=e.objectIndex;switch(n){case"materials":if(!t.material){console.error("THREE.PropertyBinding: Can not bind to material as node does not have a material.",this);return}if(!t.material.materials){console.error("THREE.PropertyBinding: Can not bind to material.materials as node.material does not have a materials array.",this);return}t=t.material.materials;break;case"bones":if(!t.skeleton){console.error("THREE.PropertyBinding: Can not bind to bones as node does not have a skeleton.",this);return}t=t.skeleton.bones;for(let h=0;h<t.length;h++)if(t[h].name===l){l=h;break}break;case"map":if("map"in t){t=t.map;break}if(!t.material){console.error("THREE.PropertyBinding: Can not bind to material as node does not have a material.",this);return}if(!t.material.map){console.error("THREE.PropertyBinding: Can not bind to material.map as node.material does not have a map.",this);return}t=t.material.map;break;default:if(t[n]===void 0){console.error("THREE.PropertyBinding: Can not bind to objectName of node undefined.",this);return}t=t[n]}if(l!==void 0){if(t[l]===void 0){console.error("THREE.PropertyBinding: Trying to bind to objectIndex of objectName, but is undefined.",this,t);return}t=t[l]}}let a=t[s];if(a===void 0){let l=e.nodeName;console.error("THREE.PropertyBinding: Trying to update property for track: "+l+"."+s+" but it wasn't found.",t);return}let o=this.Versioning.None;this.targetObject=t,t.needsUpdate!==void 0?o=this.Versioning.NeedsUpdate:t.matrixWorldNeedsUpdate!==void 0&&(o=this.Versioning.MatrixWorldNeedsUpdate);let c=this.BindingType.Direct;if(r!==void 0){if(s==="morphTargetInfluences"){if(!t.geometry){console.error("THREE.PropertyBinding: Can not bind to morphTargetInfluences because node does not have a geometry.",this);return}if(!t.geometry.morphAttributes){console.error("THREE.PropertyBinding: Can not bind to morphTargetInfluences because node does not have a geometry.morphAttributes.",this);return}t.morphTargetDictionary[r]!==void 0&&(r=t.morphTargetDictionary[r])}c=this.BindingType.ArrayElement,this.resolvedProperty=a,this.propertyIndex=r}else a.fromArray!==void 0&&a.toArray!==void 0?(c=this.BindingType.HasFromToArray,this.resolvedProperty=a):Array.isArray(a)?(c=this.BindingType.EntireArray,this.resolvedProperty=a):this.propertyName=s;this.getValue=this.GetterByBindingType[c],this.setValue=this.SetterByBindingTypeAndVersioning[c][o]}unbind(){this.node=null,this.getValue=this._getValue_unbound,this.setValue=this._setValue_unbound}};ne.Composite=bo;ne.prototype.BindingType={Direct:0,EntireArray:1,ArrayElement:2,HasFromToArray:3};ne.prototype.Versioning={None:0,NeedsUpdate:1,MatrixWorldNeedsUpdate:2};ne.prototype.GetterByBindingType=[ne.prototype._getValue_direct,ne.prototype._getValue_array,ne.prototype._getValue_arrayElement,ne.prototype._getValue_toArray];ne.prototype.SetterByBindingTypeAndVersioning=[[ne.prototype._setValue_direct,ne.prototype._setValue_direct_setNeedsUpdate,ne.prototype._setValue_direct_setMatrixWorldNeedsUpdate],[ne.prototype._setValue_array,ne.prototype._setValue_array_setNeedsUpdate,ne.prototype._setValue_array_setMatrixWorldNeedsUpdate],[ne.prototype._setValue_arrayElement,ne.prototype._setValue_arrayElement_setNeedsUpdate,ne.prototype._setValue_arrayElement_setMatrixWorldNeedsUpdate],[ne.prototype._setValue_fromArray,ne.prototype._setValue_fromArray_setNeedsUpdate,ne.prototype._setValue_fromArray_setMatrixWorldNeedsUpdate]];Gg=new Float32Array(1);typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:"169"}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__="169")});var rr,Ul=mn(()=>{sr();rr=class{constructor(t,e){ee(this,"renderer");ee(this,"scene");ee(this,"camera");ee(this,"settings");this.settings=e,this.renderer=new Xs({canvas:t,antialias:e.antialias,powerPreference:"high-performance",stencil:!1,depth:!0}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,1)*e.renderScale),this.renderer.setSize(window.innerWidth,window.innerHeight,!1),this.renderer.outputColorSpace=Ee,this.scene=new Ys,this.scene.fog=new Gi(12101736,e.fogDensity),this.scene.background=new Pt(12101736),this.camera=new ge(e.fov,window.innerWidth/window.innerHeight,.05,120),this.camera.position.set(0,1.7,0);let n=new Js(16774336,6969888,.55);this.scene.add(n);let s=new tr(12101736,.35);this.scene.add(s)}applySettings(t){this.settings=t,this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,1)*t.renderScale),this.renderer.setSize(window.innerWidth,window.innerHeight,!1),this.camera.fov=t.fov,this.camera.updateProjectionMatrix(),this.scene.fog instanceof Gi&&(this.scene.fog.density=t.fogDensity)}onResize(){this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight,!1)}render(){this.renderer.render(this.scene,this.camera)}dispose(){this.renderer.dispose()}}});function Oo(){return(Yi===null||Yi.byteLength===0)&&(Yi=new Uint8Array(Ie.memory.buffer)),Yi}function cg(i,t){return i=i>>>0,Oo().subarray(i/1,i/1+t)}function ar(i){return dn[i]}function lg(i){i<132||(dn[i]=$i,$i=i)}function hg(i){let t=ar(i);return lg(i),t}function ug(i,t){return i=i>>>0,Bl.decode(Oo().subarray(i,i+t))}function Dl(i,t){let e=t(i.length*1,1)>>>0;return Oo().set(i,e/1),Fo=i.length,e}function dg(i){$i===dn.length&&dn.push(dn.length+1);let t=$i;return $i=dn[t],dn[t]=i,t}async function fg(i,t){if(typeof Response=="function"&&i instanceof Response){if(typeof WebAssembly.instantiateStreaming=="function")try{return await WebAssembly.instantiateStreaming(i,t)}catch(n){if(i.headers.get("Content-Type")!="application/wasm")console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n",n);else throw n}let e=await i.arrayBuffer();return await WebAssembly.instantiate(e,t)}else{let e=await WebAssembly.instantiate(i,t);return e instanceof WebAssembly.Instance?{instance:e,module:i}:e}}function pg(){let i={};return i.wbg={},i.wbg.__wbindgen_copy_to_typed_array=function(t,e,n){new Uint8Array(ar(n).buffer,ar(n).byteOffset,ar(n).byteLength).set(cg(t,e))},i.wbg.__wbindgen_object_drop_ref=function(t){hg(t)},i.wbg.__wbindgen_throw=function(t,e){throw new Error(ug(t,e))},i}function mg(i,t){return Ie=i.exports,Fl.__wbindgen_wasm_module=t,Yi=null,Ie}async function Fl(i){if(Ie!==void 0)return Ie;typeof i<"u"&&(Object.getPrototypeOf(i)===Object.prototype?{module_or_path:i}=i:console.warn("using deprecated parameters for the initialization function; pass a single object instead")),typeof i>"u"&&(i=new URL("backrooms_wasm_bg.wasm",import.meta.url));let t=pg();(typeof i=="string"||typeof Request=="function"&&i instanceof Request||typeof URL=="function"&&i instanceof URL)&&(i=fetch(i));let{instance:e,module:n}=await fg(await i,t);return mg(e,n)}var Ie,Yi,dn,$i,Bl,Fo,Nl,or,Ol,kl=mn(()=>{Yi=null;dn=new Array(128).fill(void 0);dn.push(void 0,null,!0,!1);$i=dn.length;Bl=typeof TextDecoder<"u"?new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0}):{decode:()=>{throw Error("TextDecoder not available")}};typeof TextDecoder<"u"&&Bl.decode();Fo=0;Nl=typeof FinalizationRegistry>"u"?{register:()=>{},unregister:()=>{}}:new FinalizationRegistry(i=>Ie.__wbg_world_free(i>>>0,1)),or=class{__destroy_into_raw(){let t=this.__wbg_ptr;return this.__wbg_ptr=0,Nl.unregister(this),t}free(){let t=this.__destroy_into_raw();Ie.__wbg_world_free(t,0)}find_spawn(t,e){return Ie.world_find_spawn(this.__wbg_ptr,t,e)>>>0}is_blocked(t,e){return Ie.world_is_blocked(this.__wbg_ptr,t,e)!==0}collides_in_chunk(t,e,n,s,r,a){let o=Dl(a,Ie.__wbindgen_export_0),c=Fo;return Ie.world_collides_in_chunk(this.__wbg_ptr,t,e,n,s,r,o,c)!==0}constructor(t){let e=Ie.world_new(t);return this.__wbg_ptr=e>>>0,Nl.register(this,this.__wbg_ptr,this),this}gen_chunk(t,e,n){var s=Dl(n,Ie.__wbindgen_export_0),r=Fo;Ie.world_gen_chunk(this.__wbg_ptr,t,e,s,r,dg(n))}};Ol=Fl});var jl,zl=mn(()=>{jl="./backrooms_wasm_bg-PUBW34GQ.wasm?url"});var Gl={};lh(Gl,{CELL_SIZE:()=>Ht,CHUNK_SIZE:()=>ie,WALL_HEIGHT:()=>Dn,buildChunk:()=>Ho,disposeChunk:()=>Ki,getWorld:()=>cr,initMaterials:()=>jo,initWorld:()=>zo});async function zo(i){ko||(ko=(async()=>{await Ol(await fetch(jl).then(t=>t.arrayBuffer()))})()),await ko,Zi&&Zi.free?.(),Zi=new or(i)}function cr(){if(!Zi)throw new Error("World not initialized \u2014 call initWorld first");return Zi}function jo(i){let t=(e,n=1)=>{let s=new Zs(e);return s.wrapS=Tn,s.wrapT=Tn,s.repeat.set(n,n),s.colorSpace=Ee,s.anisotropy=1,s};fn={wallpaper:new Ln({map:t(i.wallpaper,1),roughness:.92,metalness:0}),carpet:new Ln({map:t(i.carpet,1),roughness:1,metalness:0}),ceiling:new Ln({map:t(i.ceiling,1),roughness:.95,metalness:0}),light:new Ln({map:t(i.lightPanel,1),emissive:new Pt(16775376),emissiveMap:t(i.lightPanel,1),emissiveIntensity:1.4,roughness:.5,metalness:0}),baseboard:new Ln({map:t(i.baseboard,4),roughness:.7,metalness:0})}}function Ho(i,t){if(!fn)throw new Error("Materials not initialized");let e=cr(),n=ie*ie,s=new Uint8Array(n);e.gen_chunk(i,t,s);let r=0,a=0;for(let k=0;k<n;k++)s[k]===Hl?r++:s[k]===Vl&&a++;let o=new Sn,c=ie*Ht,l=i*c,h=t*c,p=new Pn(c,c),f=fn.carpet.clone();f.map=fn.carpet.map.clone(),f.map.wrapS=f.map.wrapT=Tn,f.map.repeat.set(ie,ie),f.map.needsUpdate=!0;let m=new fe(p,f);m.rotation.x=-Math.PI/2,m.position.set(l+c/2,0,h+c/2),m.receiveShadow=!1,o.add(m);let _=new Pn(c,c),y=fn.ceiling.clone();y.map=fn.ceiling.map.clone(),y.map.wrapS=y.map.wrapT=Tn,y.map.repeat.set(ie,ie),y.map.needsUpdate=!0;let d=new fe(_,y);d.rotation.x=Math.PI/2,d.position.set(l+c/2,Dn,h+c/2),o.add(d);let u=new In(Ht,Dn,Ht),b=new Qn(u,fn.wallpaper,Math.max(1,r)),M=16,E=new Pn(Ht*.8,Ht*.8),B=new Qn(E,fn.light,4),C=0,w=0;for(let k=0;k<ie;k++)for(let F=0;F<ie;F++){let V=s[k*ie+F],Y=l+F*Ht+Ht/2,z=h+k*Ht+Ht/2;V===Hl&&(ye.position.set(Y,Dn/2,z),ye.rotation.set(0,0,0),ye.scale.set(1,1,1),ye.updateMatrix(),b.setMatrixAt(w++,ye.matrix))}b.count=w,b.instanceMatrix.needsUpdate=!0,o.add(b);let O=new In(.8,Dn,.8),Z=new Qn(O,fn.baseboard,Math.max(1,a)),g=0;for(let k=0;k<ie;k++)for(let F=0;F<ie;F++)if(s[k*ie+F]===Vl){let Y=l+F*Ht+Ht/2,z=h+k*Ht+Ht/2;ye.position.set(Y,Dn/2,z),ye.rotation.set(0,0,0),ye.scale.set(1,1,1),ye.updateMatrix(),Z.setMatrixAt(g++,ye.matrix)}Z.count=g,Z.instanceMatrix.needsUpdate=!0,o.add(Z);let v=0;for(let k=0;k<n&&v<4;k+=17){let F=s[k];if(F===Ag||F===_g){let V=k%ie,Y=Math.floor(k/ie),z=l+V*Ht+Ht/2,K=h+Y*Ht+Ht/2;ye.position.set(z,Dn-.05,K),ye.rotation.set(Math.PI/2,0,0),ye.scale.set(1,1,1),ye.updateMatrix(),B.setMatrixAt(v,ye.matrix);let H=new Qs(16774336,.6,Ht*5,2);H.position.set(z,Dn-.1,K),o.add(H),v++}}return B.count=v,B.instanceMatrix.needsUpdate=!0,o.add(B),o.userData={cells:s,chunkX:i,chunkY:t},{group:o,walls:b,pillars:Z,floor:m,ceiling:d,lights:B}}function Ki(i){i.group.traverse(t=>{if(t instanceof fe&&(t.geometry?.dispose(),t.material)){let e=t.material;Array.isArray(e)?e.forEach(n=>n.dispose()):e.dispose()}t instanceof Qn&&t.geometry?.dispose()})}var ko,Zi,ie,Ht,Dn,fn,Ag,Hl,Vl,_g,ye,lr=mn(()=>{sr();kl();zl();ko=null,Zi=null,ie=16,Ht=4,Dn=3.2;fn=null;Ag=0,Hl=1,Vl=2,_g=3,ye=new ve});var Ji,Wl,ql,xg,Xl,vg,Yl,hr,$l=mn(()=>{sr();lr();Ji=.35,Wl=1.7,ql=3.2,xg=1.7,Xl=12,vg=.04,Yl=9,hr=class{constructor(t){ee(this,"camera",t);ee(this,"position",new L(0,Wl,0));ee(this,"yaw",0);ee(this,"pitch",0);ee(this,"vel",new L);ee(this,"bobPhase",0);ee(this,"keys",{});ee(this,"chunkCells",new Map)}attachInput(t){document.addEventListener("keydown",e=>{this.keys[e.code]=!0}),document.addEventListener("keyup",e=>{this.keys[e.code]=!1}),t.addEventListener("click",()=>t.requestPointerLock()),document.addEventListener("pointerlockchange",()=>{}),document.addEventListener("mousemove",e=>{document.pointerLockElement&&(this.yaw-=e.movementX*.0022,this.pitch-=e.movementY*.0022,this.pitch=Math.max(-Math.PI/2+.05,Math.min(Math.PI/2-.05,this.pitch)))})}setPosition(t,e){this.position.set(t,Wl,e),this.vel.set(0,0,0)}registerChunkCells(t,e,n){this.chunkCells.set(`${t},${e}`,n)}unregisterChunkCells(t,e){this.chunkCells.delete(`${t},${e}`)}collides(t,e){let n=cr(),s=Math.floor((t-Ji)/(ie*Ht)),r=Math.floor((t+Ji)/(ie*Ht)),a=Math.floor((e-Ji)/(ie*Ht)),o=Math.floor((e+Ji)/(ie*Ht));for(let c=a;c<=o;c++)for(let l=s;l<=r;l++){let h=`${l},${c}`,p=this.chunkCells.get(h);if(p&&n.collides_in_chunk(t,e,Ji,l,c,p))return!0}return!1}update(t){let e=new L(-Math.sin(this.yaw),0,-Math.cos(this.yaw)),n=new L(Math.cos(this.yaw),0,-Math.sin(this.yaw)),s=new L;(this.keys.KeyW||this.keys.ArrowUp)&&s.add(e),(this.keys.KeyS||this.keys.ArrowDown)&&s.sub(e),(this.keys.KeyD||this.keys.ArrowRight)&&s.add(n),(this.keys.KeyA||this.keys.ArrowLeft)&&s.sub(n);let r=this.keys.ShiftLeft||this.keys.ShiftRight?xg:1;s.lengthSq()>0&&s.normalize().multiplyScalar(ql*r),this.vel.x+=(s.x-this.vel.x)*Math.min(1,Xl*t),this.vel.z+=(s.z-this.vel.z)*Math.min(1,Xl*t);let a=this.position.x+this.vel.x*t;this.collides(a,this.position.z)?this.vel.x=0:this.position.x=a;let o=this.position.z+this.vel.z*t;this.collides(this.position.x,o)?this.vel.z=0:this.position.z=o;let c=Math.hypot(this.vel.x,this.vel.z);c>.1?this.bobPhase+=Yl*t:this.bobPhase+=Yl*t*.25;let l=Math.sin(this.bobPhase)*vg*Math.min(1,c/ql);this.camera.position.copy(this.position),this.camera.position.y+=l,this.camera.rotation.order="YXZ",this.camera.rotation.y=this.yaw,this.camera.rotation.x=this.pitch}get locked(){return!!document.pointerLockElement}}});function ur(i){return function(){i|=0,i=i+1831565813|0;let t=Math.imul(i^i>>>15,1|i);return t=t+Math.imul(t^t>>>7,61|t)^t,((t^t>>>14)>>>0)/4294967296}}function dr(i,t,e,n,s,r){let a=i.createImageData(t,e);for(let o=0;o<t*e;o++){let c=(r()-.5)*s;a.data[o*4+0]=Math.max(0,Math.min(255,n[0]+c)),a.data[o*4+1]=Math.max(0,Math.min(255,n[1]+c)),a.data[o*4+2]=Math.max(0,Math.min(255,n[2]+c)),a.data[o*4+3]=255}i.putImageData(a,0,0)}function yg(i){let n=document.createElement("canvas");n.width=256,n.height=256;let s=n.getContext("2d"),r=ur(i);dr(s,256,256,[200,181,102],18,r),s.globalCompositeOperation="multiply";for(let a=0;a<256;a+=32)s.fillStyle="rgba(180, 160, 80, 0.35)",s.fillRect(a,0,8,256);s.globalCompositeOperation="source-over";for(let a=0;a<5;a++){let o=r()*256,c=r()*256,l=30+r()*60,h=s.createRadialGradient(o,c,0,o,c,l);h.addColorStop(0,"rgba(90, 70, 30, 0.35)"),h.addColorStop(.7,"rgba(110, 85, 40, 0.15)"),h.addColorStop(1,"rgba(0,0,0,0)"),s.fillStyle=h,s.fillRect(0,0,256,256)}s.strokeStyle="rgba(40, 30, 10, 0.5)",s.lineWidth=1;for(let a=0;a<8;a++){s.beginPath();let o=r()*256,c=r()*256;s.moveTo(o,c);for(let l=0;l<5;l++)o+=(r()-.5)*40,c+=(r()-.5)*40,s.lineTo(o,c);s.stroke()}return n}function Mg(i){let n=document.createElement("canvas");n.width=256,n.height=256;let s=n.getContext("2d"),r=ur(i+1);dr(s,256,256,[105,88,38],28,r);for(let o=0;o<14;o++){let c=r()*256,l=r()*256,h=20+r()*50,p=s.createRadialGradient(c,l,0,c,l,h);p.addColorStop(0,"rgba(60, 45, 15, 0.5)"),p.addColorStop(1,"rgba(0,0,0,0)"),s.fillStyle=p,s.fillRect(0,0,256,256)}let a=s.getImageData(0,0,256,256);for(let o=0;o<256*256;o+=1)if(r()<.18){let c=-40+r()*20;a.data[o*4+0]=Math.max(0,a.data[o*4+0]+c),a.data[o*4+1]=Math.max(0,a.data[o*4+1]+c),a.data[o*4+2]=Math.max(0,a.data[o*4+2]+c)}return s.putImageData(a,0,0),n}function Sg(i){let n=document.createElement("canvas");n.width=256,n.height=256;let s=n.getContext("2d"),r=ur(i+2);dr(s,256,256,[195,178,110],12,r),s.fillStyle="rgba(120, 100, 50, 0.55)";for(let a=0;a<600;a++){let o=r()*256,c=r()*256;s.fillRect(o|0,c|0,1,1)}return s.strokeStyle="rgba(80, 65, 25, 0.8)",s.lineWidth=2,s.beginPath(),s.moveTo(256/2,0),s.lineTo(256/2,256),s.moveTo(0,256/2),s.lineTo(256,256/2),s.stroke(),n}function bg(){let e=document.createElement("canvas");e.width=128,e.height=128;let n=e.getContext("2d"),s=n.createRadialGradient(128/2,128/2,0,128/2,128/2,128/1.5);return s.addColorStop(0,"rgb(255, 252, 230)"),s.addColorStop(.7,"rgb(245, 240, 200)"),s.addColorStop(1,"rgb(220, 210, 160)"),n.fillStyle=s,n.fillRect(0,0,128,128),n.fillStyle="rgba(255, 255, 240, 0.85)",n.fillRect(8,128*.3-3,112,6),n.fillRect(8,128*.7-3,112,6),e}function Eg(){let e=document.createElement("canvas");e.width=128,e.height=32;let n=e.getContext("2d"),s=ur(99);dr(n,128,32,[60,40,20],18,s),n.strokeStyle="rgba(30, 18, 8, 0.6)",n.lineWidth=1;for(let r=0;r<6;r++){let a=s()*32;n.beginPath(),n.moveTo(0,a);for(let o=0;o<128;o+=8)n.lineTo(o,a+Math.sin(o*.1)*1.5);n.stroke()}return e}function Zl(i){return{wallpaper:yg(i),carpet:Mg(i),ceiling:Sg(i),lightPanel:bg(),baseboard:Eg()}}var Kl=mn(()=>{});var Vo,fr,Jl=mn(()=>{Vo="audio/",fr=class{constructor(){ee(this,"ctx",null);ee(this,"masterGain",null);ee(this,"ambGain",null);ee(this,"musicGain",null);ee(this,"sfxGain",null);ee(this,"ambSource",null);ee(this,"musicSource",null);ee(this,"buffers",new Map);ee(this,"settings",{master:1,ambience:.8,music:.7,sfx:.9})}async ensureContext(){if(this.ctx){if(this.ctx.state==="suspended")try{await this.ctx.resume()}catch{}return}let t=window.AudioContext||window.webkitAudioContext;this.ctx=new t,this.masterGain=this.ctx.createGain(),this.ambGain=this.ctx.createGain(),this.musicGain=this.ctx.createGain(),this.sfxGain=this.ctx.createGain(),this.ambGain.connect(this.masterGain),this.musicGain.connect(this.masterGain),this.sfxGain.connect(this.masterGain),this.masterGain.connect(this.ctx.destination),this.applySettings()}setSettings(t){this.settings=t,this.applySettings()}applySettings(){!this.ctx||!this.masterGain||(this.masterGain.gain.value=this.settings.master,this.ambGain.gain.value=this.settings.ambience,this.musicGain.gain.value=this.settings.music,this.sfxGain.gain.value=this.settings.sfx)}async loadBuffer(t,e){if(this.buffers.has(t))return this.buffers.get(t);let s=await(await fetch(e)).arrayBuffer(),r=await this.ctx.decodeAudioData(s);return this.buffers.set(t,r),r}async startMenuMusic(){if(await this.ensureContext(),!this.ctx)return;let t=await this.loadBuffer("menu",Vo+"menu_mus.ogg");this.stopMenuMusic();let e=this.ctx.createBufferSource();e.buffer=t,e.loop=!0,e.connect(this.musicGain),e.start(0),this.musicSource=e}stopMenuMusic(){if(this.musicSource){try{this.musicSource.stop()}catch{}this.musicSource.disconnect(),this.musicSource=null}}async startAmbience(){if(await this.ensureContext(),!this.ctx)return;let t=await this.loadBuffer("amb",Vo+"level0_ambience.mp3");if(this.ambSource){try{this.ambSource.stop()}catch{}this.ambSource.disconnect()}let e=this.ctx.createBufferSource();e.buffer=t,e.loop=!0,e.connect(this.ambGain),e.start(0),this.ambSource=e}stopAmbience(){if(this.ambSource){try{this.ambSource.stop()}catch{}this.ambSource.disconnect(),this.ambSource=null}}async playSfx(t){if(await this.ensureContext(),!this.ctx)return;let e=t==="falling_wind"?"falling_wind.mp3":t==="landing_thud"?"landing_thud.mp3":t==="horror_1"?"horror_1.mp3":"horror_2.mp3",n=await this.loadBuffer(t,Vo+e),s=this.ctx.createBufferSource();s.buffer=n,s.connect(this.sfxGain),s.start(0)}async playRandomHorror(){let t=Math.random()<.5?"horror_1":"horror_2";await this.playSfx(t)}fadeOut(t=600){if(!this.ctx||!this.masterGain)return;let e=this.ctx.currentTime,n=this.masterGain.gain.value;this.masterGain.gain.cancelScheduledValues(e),this.masterGain.gain.setValueAtTime(n,e),this.masterGain.gain.linearRampToValueAtTime(0,e+t/1e3)}fadeIn(t=600){if(!this.ctx||!this.masterGain)return;let e=this.ctx.currentTime;this.masterGain.gain.cancelScheduledValues(e),this.masterGain.gain.setValueAtTime(0,e),this.masterGain.gain.linearRampToValueAtTime(this.settings.master,e+t/1e3)}}});var Hg=ch(()=>{Ul();$l();lr();Kl();Jl();var Ql={audio:{master:1,ambience:.8,music:.7,sfx:.9},render:{renderScale:.85,fogDensity:.035,fov:75,antialias:!1}},gr=document.getElementById("game-canvas"),wg=document.getElementById("title-screen"),Go=document.getElementById("settings-panel"),Ar=document.getElementById("cutscene-overlay"),pr=document.getElementById("cutscene-text"),Tg=document.getElementById("hud"),th=document.getElementById("fps-counter"),Rg=document.getElementById("btn-new-game"),Cg=document.getElementById("btn-settings"),Ig=document.getElementById("btn-quit"),Pg=document.getElementById("btn-close-settings"),Xo=document.getElementById("s-master"),Yo=document.getElementById("s-amb"),$o=document.getElementById("s-mus"),Zo=document.getElementById("s-sfx"),Ko=document.getElementById("s-scale"),Jo=document.getElementById("s-fog"),Qo=document.getElementById("s-fov"),tc=document.getElementById("s-aa"),Ae=null,qe=null,_e,re=Lg(),yr="TITLE",Nn=new Map,Qi=2,Mr=0,Wo=performance.now(),_r=0,xr=0,vr=0,qo=0;function Lg(){try{let i=localStorage.getItem("backrooms-settings");if(i)return{...Ql,...JSON.parse(i)}}catch{}return JSON.parse(JSON.stringify(Ql))}function Ug(){try{localStorage.setItem("backrooms-settings",JSON.stringify(re))}catch{}}function Dg(){Xo.value=String(re.audio.master),Yo.value=String(re.audio.ambience),$o.value=String(re.audio.music),Zo.value=String(re.audio.sfx),Ko.value=String(re.render.renderScale),Jo.value=String(re.render.fogDensity),Qo.value=String(re.render.fov),tc.checked=re.render.antialias}function Ng(){re.audio.master=parseFloat(Xo.value),re.audio.ambience=parseFloat(Yo.value),re.audio.music=parseFloat($o.value),re.audio.sfx=parseFloat(Zo.value),re.render.renderScale=parseFloat(Ko.value),re.render.fogDensity=parseFloat(Jo.value),re.render.fov=parseFloat(Qo.value),re.render.antialias=tc.checked,Ug(),_e.setSettings(re.audio),Ae&&Ae.applySettings(re.render)}[Xo,Yo,$o,Zo,Ko,Jo,Qo,tc].forEach(i=>{i.addEventListener("input",Ng)});function Sr(i){yr=i,wg.style.display=i==="TITLE"?"flex":"none",Ar.style.display=i==="CUTSCENE"?"flex":"none",Tg.style.display=i==="GAME"?"flex":"none",gr.style.display=i==="GAME"?"block":"none"}async function Bg(){Sr("TITLE"),_e.stopAmbience(),await _e.startMenuMusic()}async function Fg(){let i=new Uint32Array(1);crypto.getRandomValues(i),Mr=i[0],console.log("New Backrooms seed:",Mr),_e.stopMenuMusic(),Sr("CUTSCENE"),await Og(),await kg()}async function Og(){Ar.style.background="radial-gradient(circle at center, #1a1500 0%, #000 100%)",pr.textContent="You feel weightless...",pr.style.opacity="1",_e.playSfx("falling_wind"),await mr(2e3),pr.textContent="...you fall through the floor.",await mr(1800),_e.playSfx("landing_thud"),Ar.style.background="#b8a868",pr.style.opacity="0",await mr(700),Ar.style.background="#000",await mr(150)}function mr(i){return new Promise(t=>setTimeout(t,i))}async function kg(){await zo(Mr);let i=Zl(Mr);jo(i),Ae?Ae.applySettings(re.render):(Ae=new rr(gr,re.render),window.addEventListener("resize",()=>Ae?.onResize()));for(let[,o]of Nn)Ae.scene.remove(o.group),Ki(o);Nn.clear(),qe||(qe=new hr(Ae.camera),qe.attachInput(gr));let e=(await Promise.resolve().then(()=>(lr(),Gl))).getWorld().find_spawn(0,0),n=e&255,s=e>>8&255,r=n*Ht+Ht/2,a=s*Ht+Ht/2;qe.setPosition(r,a),eh(),Sr("GAME"),await _e.startAmbience(),Wo=performance.now(),_r=0,xr=0,vr=0,qo=performance.now()+3e4+Math.random()*6e4,gr.requestPointerLock?.()}function zg(i,t){return`${i},${t}`}function eh(){if(!Ae||!qe)return;let i=Math.floor(qe.position.x/(ie*Ht)),t=Math.floor(qe.position.z/(ie*Ht)),e=[];for(let r=-Qi;r<=Qi;r++)for(let a=-Qi;a<=Qi;a++)e.push([i+a,t+r]);let n=2;for(let[r,a]of e){if(n<=0)break;let o=zg(r,a);if(!Nn.has(o)){let c=Ho(r,a);Ae.scene.add(c.group),Nn.set(o,c),qe.registerChunkCells(r,a,c.group.userData.cells),n--}}let s=Qi+1;for(let[r,a]of Nn){let[o,c]=r.split(",").map(Number);(Math.abs(o-i)>s||Math.abs(c-t)>s)&&(Ae.scene.remove(a.group),Ki(a),Nn.delete(r),qe.unregisterChunkCells(o,c))}}function nh(i){requestAnimationFrame(nh);let t=Math.min(.1,(i-Wo)/1e3);if(Wo=i,yr==="GAME"&&Ae&&qe&&(qe.update(t),eh(),i>=qo&&(_e.playRandomHorror(),qo=i+6e4+Math.random()*12e4),Ae.render(),_r++,xr+=t,vr+=t,vr>=.5)){let e=Math.round(_r/xr);th&&(th.textContent=`FPS: ${e}`),_r=0,xr=0,vr=0}}Rg.addEventListener("click",async()=>{await _e.ensureContext(),await Fg()});Cg.addEventListener("click",()=>{Go.style.display=Go.style.display==="flex"?"none":"flex"});Pg.addEventListener("click",()=>{Go.style.display="none"});Ig.addEventListener("click",async()=>{if(_e.stopAmbience(),_e.fadeOut(200),setTimeout(()=>_e.fadeIn(200),250),document.pointerLockElement&&document.exitPointerLock(),Ae){for(let[,i]of Nn)Ae.scene.remove(i.group),Ki(i);Nn.clear()}await Bg()});document.addEventListener("pointerlockchange",()=>{document.pointerLockElement});async function jg(){_e=new fr,_e.setSettings(re.audio),Dg(),requestAnimationFrame(nh),Sr("TITLE");let i=async()=>{await _e.ensureContext(),await _e.startMenuMusic(),window.removeEventListener("click",i),window.removeEventListener("keydown",i)};window.addEventListener("click",i),window.addEventListener("keydown",i)}jg()});export default Hg();
