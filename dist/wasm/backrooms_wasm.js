...
export class World {
     ...
     * @returns {number}
     */
    find_spawn(chunk_x, chunk_y) {
        const ret = wasm.world_find_spawn(this.__wbg_ptr, chunk_x, chunk_y);
        return ret >>> 0;
    }
    /**
     ...
     */
    is_blocked(wx, wy) {
        const ret = wasm.world_is_blocked(this.__wbg_ptr, wx, wy);
        return ret !== 0;
    }
    /**
     ...
     * @returns {boolean}
     */
    collides_in_chunk(px, py, r, chunk_x, chunk_y, cells) {
        const ptr0 = passArray8ToWasm0(cells, wasm.__wbindgen_export_0);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.world_collides_in_chunk(this.__wbg_ptr, px, py, r, chunk_x, chunk_y, ptr0, len0);
        return ret !== 0;
    }
    /**
     * @param {number} seed
     ...
     */
    gen_chunk(chunk_x, chunk_y, out) {
        var ptr0 = passArray8ToWasm0(out, wasm.__wbindgen_export_0);
        var len0 = WASM_VECTOR_LEN;
        wasm.world_gen_chunk(this.__wbg_ptr, chunk_x, chunk_y, ptr0, len0, addHeapObject(out));
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('backrooms_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
